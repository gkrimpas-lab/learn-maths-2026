...
const CHAPTERS = [
  {
    id: '01',
    slug: '01-dinami-riton-ekth-akeraio',
    title: 'Δυνάμεις ρητών με εκθέτη ακέραιο',
    desc: 'Δυνάμεις ρητών με εκθέτη ακέραιο, Ιδιότητες δυνάμεων, ρητοί αριθμοί, δύναμη.',
    badge: 'ΚΕΦΑΛΑΙΟ 1',
    active: true,
  },
  {
  ...
  {
    id: '03',
    slug: '03-arithmitiki-parastasi',
    title: 'Υπολογισμός αριθμητικών παραστάσεων',
    desc: 'Υπολογισμός αριθμητικών παραστάσεων, προτεραιότητα πράξεων, εκθέτες θετικοί και αρνητικοί αριθμοί.',
    badge: 'ΚΕΦΑΛΑΙΟ 3',
    active: true,
  },
  {
    id: '04',
    slug: '04-riza',
    title: 'Ρητοί και άρρητοι αριθμοί',
    desc: 'Ρητοί και άρρητοι αριθμοί, δεκαδικές αναπαραστάσεις, περιοδικοί δεκαδικοί.',
    badge: 'ΚΕΦΑΛΑΙΟ 4',
    active: true,
  },
  {
    id: '05',
    slug: '05-ritoi-arritoi',
...
export default function AGymnasiouIndex() {
  return (
    <Layout
      title="Μαθηματικά Β' Γυμνασίου | LearnMaths.gr"
      description="Διαδραστικά μαθήματα, θεωρία και ασκήσεις για τα Μαθηματικά της Β' Γυμνασίου."
      backUrl="/"
      backText="Αρχική"
      showAds={true}
    >
        ...
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-950 via-indigo-900 to-indigo-800 text-white p-6 sm:p-10 lg:p-12 shadow-xl border border-indigo-700/50">
          <div className="max-w-4xl space-y-3">
            <span className="inline-block px-3 py-1 rounded-full text-xs sm:text-sm font-bold tracking-wider bg-indigo-500/30 text-indigo-200 border border-indigo-400/30">
              Β' ΓΥΜΝΑΣΙΟΥ • ΔΙΑΔΡΑΣΤΙΚΑ ΜΑΘΗΜΑΤΑ
            </span>
