...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Σωστά! Για κάθε αριθμό α ισχύει α × 0 ＝ 0, άρα το 0 είναι πολλαπλάσιο όλων των αριθμών.'
    ...
    q6: {
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Σωστά! Επειδή οι φυσικοί αριθμοί είναι άπειροι, τα πολλαπλάσια ενός αριθμού δεν τελειώνουν ποτέ.'
...
export default function PollaplasiaExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Πολλαπλάσια Αριθμού - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στα πολλαπλάσια φυσικών αριθμών για τη ΣΤ' Δημοτικού." />
