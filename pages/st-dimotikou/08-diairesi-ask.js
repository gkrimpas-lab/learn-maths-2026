...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? `Το υπόλοιπο (υ) είναι πάντα αυστηρά μικρότερο από τον διαιρέτη (υ < δ).`
        : `Το υπόλοιπο ΔΕΝ μπορεί να είναι ίσο ή μεγαλύτερο από τον διαιρέτη.`
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Ο Διαιρετέος ισούται πάντα με το γινόμενο του Διαιρέτη επί το Πηλίκο συν το Υπόλοιπο.'
        : 'Ο σωστός τύπος είναι: Δ = (δ × π) + υ.'
    },
    q7: {
      type: 'input',
...
export default function DiairesiExercisesPage() {
  ...
  return (
    <Layout
      ...
      description="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στη διαίρεση φυσικών αριθμών για τη ΣΤ' Δημοτικού."
              ...
              <div className="bg-slate-100 rounded-2xl p-3 mb-4 flex justify-center overflow-x-auto">
                <div className="flex flex-wrap gap-2 justify-center max-w-xs">
                  {[...Array(questions.q7.divisor)].map((_, i) => (
                    <div key={i} className="bg-white border-2 border-emerald-300 p-2 rounded-xl flex items-center justify-center min-w-[45px] shadow-xs">
