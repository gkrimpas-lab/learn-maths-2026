                    ...
                    <div className="bg-white p-3.5 rounded-2xl border border-indigo-200 shadow-xs space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-11 py-2 bg-slate-100 hover:bg-slate-200 text-indigo-700 border border-slate-200 rounded-xl font-black transition shadow-xs text-lg"
                        >
                          -
                        </button>
                        <input
                          ...
                          className="flex-1 text-center font-mono font-black text-2xl text-indigo-600 bg-indigo-50/50 border-2 border-indigo-200 rounded-xl p-1.5 focus:border-indigo-500 outline-none shadow-inner"
                        />
                        <button
                          type="button"
                          onClick={() => handleNumeratorChange(1)}
                          className="w-11 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-black transition shadow-md text-lg"
                        >
                          +
                        </button>
                      </div>
                    ...
                    <div className="bg-white p-3.5 rounded-2xl border border-amber-200 shadow-xs space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-11 py-2 bg-slate-100 hover:bg-slate-200 text-amber-700 border border-slate-200 rounded-xl font-black transition shadow-xs text-lg"
                        >
                          -
                        </button>
                        <input
                          ...
                          className="flex-1 text-center font-mono font-black text-2xl text-amber-600 bg-amber-50/50 border-2 border-amber-200 rounded-xl p-1.5 focus:border-amber-500 outline-none shadow-inner"
                        />
                        <button
                          type="button"
                          onClick={() => handleDenominatorChange(1)}
                          className="w-11 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-xl font-black transition shadow-md text-lg"
                        >
                          +
                        </button>
                      </div>
