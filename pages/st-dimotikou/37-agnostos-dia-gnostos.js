...
export default function AgnostosDiaGnostosPage() {
  ...
  return (
    <Layout
      title="➗ 37. Εξισώσεις: Άγνωστος Διαιρετέος (x : α ＝ β) - LearnMaths.gr"
      description="Διαδραστική θεωρία με 3D ζυγαριά, χωρισμό του κουτιού x σε κομμάτια και ανασύνθεση με πολλαπλασιασμό (x : α = β) για τη ΣΤ' Δημοτικού."
          ...
          <div className="bg-blue-50/80 border border-blue-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            ...
            <div className="text-center">
              <span className="bg-blue-50 border border-blue-200 px-3 py-2 rounded-xl text-blue-900 text-xs font-mono font-bold inline-flex flex-wrap items-center justify-center gap-1.5 leading-relaxed break-words max-w-full">
                <span>x : 3 ＝ 2</span>
                <span className="text-blue-700 font-normal">(1 κομμάτι έχει 2)</span>
              </span>
            </div>
          </div>
        ...
        <div className="bg-white p-4 sm:p-6 md:p-8 rounded-3xl border border-gray-200 shadow-sm space-y-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-gray-100 pb-5">
            ...
            <div className="flex flex-wrap bg-slate-100 p-1.5 rounded-2xl border border-slate-200 shadow-inner gap-1 w-full sm:w-auto">
              ...
              >
                3️⃣ Όλα τα Κομμάτια (x ＝ {exactSolution})
              </button>
            </div>
          </div>
                    ...
                    <div className="flex flex-col justify-between space-y-1.5">
                      ...
                      <div className="grid grid-cols-[36px_1fr_36px] items-center bg-slate-50 p-1 rounded-xl border border-slate-200 h-11">
                        <button 
                          type="button" 
                          disabled={activeA <= 2}
                          onClick={(e) => { e.preventDefault(); e.stopPropagation(); adjustA(-1); }} 
                          className="w-9 h-9 font-black text-blue-600 hover:bg-slate-200 disabled:opacity-25 rounded-lg active:scale-95 transition flex items-center justify-center text-lg shrink-0"
                        >
                          -
                        </button>
                ...
                <div className="p-2 sm:p-4 bg-gradient-to-b from-slate-50 to-slate-100/80 rounded-3xl border border-slate-200 shadow-inner flex flex-col items-center justify-center min-h-[360px] overflow-hidden">
                  <svg width="100%" height="340" viewBox="0 0 760 360" className="overflow-visible select-none max-w-full">
                    ...
                    <text x="150" y="325" fill="#1e3a8a" fontSize="13.5" fontWeight="900" textAnchor="middle" fontFamily="monospace">
                      {currentStep === 3 ? `x ＝ ${exactSolution} μπάλες (${activeA} · ${activeB})` : `1 από τα ${activeA} κομμάτια (x : ${activeA})`}
                    </text>
