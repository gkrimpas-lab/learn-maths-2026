...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Η προσθήκη μηδενικών στο τέλος του δεκαδικού μέρους δεν αλλάζει την αξία του αριθμού.'
        : 'Τα μηδενικά στο τέλος του δεκαδικού μέρους δεν αλλάζουν την αξία (π.χ. 5,4 = 5,40 = 5,400).'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Κάθε δεκαδική μονάδα είναι 10 φορές μεγαλύτερη από την αμέσως δεξιά της (1 δέκατο = 10 εκατοστά = 100 χιλιοστά).'
        : 'Το 1 δέκατο (0,1) είναι 10 φορές ΜΕΓΑΛΥΤΕΡΟ από το 1 εκατοστό (0,01).'
    },
    q7: {
      type: 'input',
