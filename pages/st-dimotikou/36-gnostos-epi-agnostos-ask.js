...
// Δεξαμενή σεναρίων προβλημάτων με δυναμική παραγωγή τυχαίων αριθμών
const SCENARIO_TEMPLATES = [
  {
    generate: () => {
      ...
      const b = a * x;
      return {
        prompt: `Ο Κώστας αγόρασε ${a} ίδια τετράδια (x ευρώ το ένα) και πλήρωσε συνολικά ${b} ευρώ. Πόσο κόστιζε το κάθε τετράδιο;`,
        correct: `${x} ευρώ`,
        a,
        b,
        x,
  ...
  },
  {
    generate: () => {
      ...
      const b = a * x;
      return {
        prompt: `Ένας γεωργός συσκεύασε ${b} κιλά πατάτες σε ${a} όμοια σακιά (x κιλά το καθένα). Πόσα κιλά περιείχε το κάθε σακί;`,
        correct: `${x} κιλά`,
        a,
        b,
        x,
  ...
  },
  {
    generate: () => {
      ...
      const x = getRandomInt(6, 14);
      const b = a * x;
      return {
        prompt: `Σε μια αποθήκη τοποθετήθηκαν ${a} κιβώτια με ίσο αριθμό από μπουκάλια χυμού (x μπουκάλια το καθένα). Αν όλα μαζί είναι ${b} μπουκάλια, πόσα έχει κάθε κιβώτιο;`,
        correct: `${x} μπουκάλια`,
        a,
        b,
        x,
...
function generateQuestions() {
  ...
  const q6Text = q6IsTrue
    ...
    : 'Στην εξίσωση x · 5 ＝ 35 δεν μπορούμε να κάνουμε διαίρεση επειδή το x είναι πρώτο.';

  // Q7: Input - Εξίσωση με κλάσματα: a/b · x = c/d
  const q7Den = getRandomInt(3, 8);
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Η αντίστροφη πράξη του πολλαπλασιασμού είναι η διαίρεση: x ＝ β : α.'
        : 'Για να βρούμε τον άγνωστο παράγοντα κάνουμε διαίρεση (x ＝ β : α).'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Λόγω της αντιμεταθετικής ιδιότητας του πολλαπλασιασμού, είτε το x είναι πρώτος είτε δεύτερος παράγοντας, λύνεται πάντα με διαίρεση: x ＝ β : α.'
        : 'Και στις δύο περιπτώσεις ο άγνωστος είναι παράγοντας γινομένου και υπολογίζεται με διαίρεση.'
    },
    q7: {
      type: 'input',
    ...
    q8: {
      ...
      options: q8Options,
      correct: sc.correct,
      explain: `Σχηματίζουμε την εξίσωση ${sc.a} · x ＝ ${sc.b} ➔ x ＝ ${sc.b} : ${sc.a} ＝ ${sc.correct}.`
    }
  };
}
...
export default function GnostosEpiAgnostosExercisesPage() {
  ...
  return (
    <Layout
      title="🎯 Ασκήσεις: 36. Άγνωστος Παράγοντας (α · x = β) - ΣΤ' Δημοτικού | LearnMaths.gr"
      description="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην επίλυση εξισώσεων με άγνωστο παράγοντα γινομένου (α · x = β) για τη ΣΤ' Δημοτικού."
