...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Η διαίρεση με 10, 100, 1000 μικραίνει τον αριθμό, άρα η υποδιαστολή μετακινείται αριστερά.'
        : 'Η διαίρεση με το 100 μετακινεί την υποδιαστολή 2 θέσεις προς τα ΑΡΙΣΤΕΡΑ (όχι δεξιά).'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Η διαίρεση με το 0,1 ισοδυναμεί με πολλαπλασιασμό επί 10, επομένως ο αριθμός μεγαλώνει.'
        : 'Η διαίρεση με το 0,01 ΜΕΓΑΛΩΝΕΙ τον αριθμό κατά 100 φορές.'
    },
    q7: {
      type: 'input',
...
export default function DiairesiDinameisDekaExercisesPage() {
  ...
  return (
    <Layout
      ...
      description="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στη διαίρεση με δυνάμεις του 10 για τη ΣΤ' Δημοτικού."
