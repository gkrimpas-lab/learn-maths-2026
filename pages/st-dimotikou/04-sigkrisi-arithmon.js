...
export default function SigkrisiArithmonPage() {
  ...
  return (
    <Layout
      title="⚖️ 4. Σύγκριση και Διάταξη Αριθμών - LearnMaths.gr"
      ...
      <div className="space-y-8 md:space-y-10 py-6 md:py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-50/80 border border-blue-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-2.5">
              ...
              <h3 className="text-lg font-black text-slate-900">Σύγκριση Φυσικών</h3>
          ...
          <div className="bg-indigo-50/80 border border-indigo-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-2.5">
              ...
              <h3 className="text-lg font-black text-slate-900">Σύγκριση Δεκαδικών</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="bg-cyan-50/80 border border-cyan-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-2.5">
              ...
              <h3 className="text-lg font-black text-slate-900">Το Κόλπο των Μηδενικών</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
        ...
        <div className="bg-white p-4 sm:p-6 md:p-8 rounded-3xl border border-gray-200 shadow-sm space-y-8">
          ...
          <div className="space-y-6">
            ...
            {/* ROW 2: DYNAMIC INTERACTIVE SVG BALANCE SCALE */}
            <div className="bg-slate-50 border border-slate-200 p-4 sm:p-5 md:p-6 rounded-2xl flex flex-col items-center justify-between space-y-6">
              ...
              {/* SVG BALANCE SCALE */}
              <div className="w-full max-w-lg bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-center overflow-hidden">
                <svg viewBox="0 0 400 220" className="w-full max-w-sm sm:max-w-md md:max-w-lg h-auto select-none">
                  {/* Stand & Base */}
              ...
              <div className="bg-white border border-slate-200 px-4 sm:px-6 py-3 rounded-2xl shadow-xs text-center max-w-2xl">
            ...
            {/* ROW 3: STEP-BY-STEP RULES COMPARISON CARDS */}
