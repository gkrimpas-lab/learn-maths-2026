...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Ο πολλαπλασιασμός με 10, 100, 1000 μεγαλώνει τον αριθμό, άρα η υποδιαστολή μετακινείται δεξιά.'
        : 'Ο πολλαπλασιασμός με το 100 μετακινεί την υποδιαστολή 2 θέσεις προς τα ΔΕΞΙΑ (όχι αριστερά).'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Ο πολλαπλασιασμός με το 0,1 ισοδυναμεί με διαίρεση δια 10, επομένως ο αριθμός μικραίνει.'
        : 'Ο πολλαπλασιασμός με το 0,01 ΜΙΚΡΑΙΝΕΙ τον αριθμό κατά 100 φορές.'
    },
    q7: {
      type: 'input',
