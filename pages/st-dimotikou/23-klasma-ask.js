...
export default function KlasmaExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Η Έννοια του Κλάσματος - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην έννοια του κλάσματος για τη ΣΤ' Δημοτικού." />
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q3')}`}>
                ...
                <div className="w-full bg-slate-50 p-3 rounded-2xl border border-slate-200 mb-3 flex gap-1 shadow-inner">
