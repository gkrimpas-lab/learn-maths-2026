...
export default function ProblemAnalogaPosaTheoryPage() {
  ...
  const [litersInitial, setLitersInitial] = useState(3);      // l λαδιου
  const [olivesKgInitial, setOlivesKgInitial] = useState(15);  // kg ελιων
  const [targetMlLiters, setTargetMlLiters] = useState(7500);  // 7.500 ml
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Προετοιμασία</span>
                </div>
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <div className="bg-slate-50 p-4 2xl:p-5 rounded-2xl border border-slate-200 space-y-2 text-xs sm:text-sm text-center">
                  ...
                  <div className="font-mono font-bold text-indigo-800 text-sm pt-1">
                    χ ＝ (β · γ) : α
                  </div>
                </div>
              </div>
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">3η Μέθοδος</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
                ...
                <div className="space-y-2 text-xs sm:text-sm font-mono text-center">
                  <div className="p-2.5 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-950 font-bold text-sm">
                    ψ ＝ λ · χ
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 2xl:gap-6">
            ...
            <div className="bg-blue-50/70 p-4 2xl:p-5 rounded-2xl border border-blue-200 space-y-2">
              <div className="h-8 flex items-center justify-between text-left">
                ...
                <span className="font-mono font-black text-lg text-blue-600 bg-white px-2 py-0.5 rounded-lg border border-blue-200">
                  {itemsInitial}
                </span>
              </div>
            ...
            <div className="bg-emerald-50/70 p-4 2xl:p-5 rounded-2xl border border-emerald-200 space-y-2">
              <div className="h-8 flex items-center justify-between text-left">
                ...
                <span className="font-mono font-black text-lg text-emerald-600 bg-white px-2 py-0.5 rounded-lg border border-emerald-200">
                  {costInitial} €
                </span>
              </div>
              <div className="grid grid-cols-[36px_1fr_36px] items-center h-11 w-full gap-2">
            ...
            <div className="bg-amber-50/70 p-4 2xl:p-5 rounded-2xl border border-amber-200 space-y-2">
              <div className="h-8 flex items-center justify-between text-left">
                ...
                <span className="font-mono font-black text-lg text-amber-600 bg-white px-2 py-0.5 rounded-lg border border-amber-200">
                  {itemsTarget}
                </span>
              </div>
              <div className="grid grid-cols-[36px_1fr_36px] items-center h-11 w-full gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-2">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-xs sm:text-sm text-slate-700 font-mono">
                  <div className="p-3 bg-white rounded-xl border border-slate-200 space-y-1">
                    <span className="text-slate-500 font-sans block text-xs">1ο Βήμα (Τιμή του 1):</span>
                    <div>{costInitial} : {itemsInitial} ＝ <strong>{formatNum(unitRate)} €</strong></div>
                  </div>
                  <div className="p-3 bg-white rounded-xl border border-slate-200 space-y-1">
                    <span className="text-slate-500 font-sans block text-xs">2ο Βήμα (Για τα {itemsTarget}):</span>
                    <div>{itemsTarget} · {formatNum(unitRate)} ＝ <strong>{formatNum(targetCost)} €</strong></div>
                  </div>
                </div>
              </div>
              <div className="p-3 bg-amber-50 rounded-xl border border-amber-200 text-center font-bold text-xs text-amber-900">
            ...
            <div className="bg-slate-50 rounded-2xl border border-slate-200 p-5 space-y-4 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <div className="bg-white rounded-xl border border-slate-200 p-2.5 font-mono text-xs text-center space-y-1">
                ...
                <div className="p-3 bg-white rounded-xl border border-slate-200 font-mono text-xs text-slate-700 text-center">
                  χ ＝ ({costInitial} · {itemsTarget}) : {itemsInitial}<br />
                  χ ＝ {costInitial * itemsTarget} : {itemsInitial} ＝ <strong>{formatNum(targetCost)} €</strong>
                </div>
              </div>
              <div className="p-3 bg-indigo-50 rounded-xl border border-indigo-200 text-center font-bold text-xs text-indigo-900">
                Αποτέλεσμα: {formatNum(targetCost)} €
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl border border-slate-200 p-5 space-y-4 flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-xs sm:text-sm text-slate-700 font-mono">
                  <div className="p-3 bg-white rounded-xl border border-slate-200 space-y-1">
                    <span className="text-slate-500 font-sans block text-xs">Εύρεση λ (ψ : χ):</span>
                    <div>λ ＝ {costInitial} : {itemsInitial} ＝ <strong>{formatNum(unitRate)}</strong></div>
                  </div>
                  <div className="p-3 bg-white rounded-xl border border-slate-200 space-y-1">
                    <span className="text-slate-500 font-sans block text-xs">Τύπος (ψ ＝ λ · χ):</span>
                    <div>ψ ＝ {formatNum(unitRate)} · {itemsTarget} ＝ <strong>{formatNum(targetCost)} €</strong></div>
                  </div>
                </div>
              </div>
              <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 text-center font-bold text-xs text-emerald-900">
                Αποτέλεσμα: {formatNum(targetCost)} €
              </div>
            </div>
