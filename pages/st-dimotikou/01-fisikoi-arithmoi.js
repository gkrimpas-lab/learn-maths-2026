          ...
          <div className={`${LAYOUT.CONTAINER} grid grid-cols-1 lg:grid-cols-12 gap-8 items-center`}>
            ...
            <div className="lg:col-span-4 bg-white/10 backdrop-blur-md border border-white/25 rounded-3xl p-6 text-center space-y-4 shadow-xl">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100 mt-1">8 διαδραστικές ερωτήσεις με άμεση βαθμολόγηση!</p>
              </div>
              <Link 
                href="/st-dimotikou/01-fysikoi-ask" 
        ...
        <main className={`${LAYOUT.LESSON_CONTAINER} py-12 space-y-12`}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-blue-50/70 border border-blue-100 p-6 rounded-3xl space-y-3 shadow-sm hover:shadow-md transition">
              ...
              <h2 className="text-lg font-black text-slate-900">Τι είναι οι Φυσικοί Αριθμοί;</h2>
            ...
            <div className="bg-indigo-50/70 border border-indigo-100 p-6 rounded-3xl space-y-3 shadow-sm hover:shadow-md transition">
              ...
              <h2 className="text-lg font-black text-slate-900">Περίοδοι & Τάξεις</h2>
              <p className="text-sm text-slate-600 leading-relaxed">
                Χωρίζουμε τους μεγάλους αριθμούς σε <strong>τριάδες</strong> από τα δεξιά προς τα αριστερά. Κάθε περίοδος περιλαμβάνει:
              </p>
              <ul className="text-xs text-slate-700 space-y-1 font-medium bg-white p-3 rounded-xl border border-indigo-100">
            ...
            <div className="bg-emerald-50/70 border border-emerald-100 p-6 rounded-3xl space-y-3 shadow-sm hover:shadow-md transition">
              ...
              <h2 className="text-lg font-black text-slate-900">Αξία Θέσης Ψηφίου</h2>
              <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    <div className="grid grid-cols-12 text-[10px] font-black text-slate-500 text-center border-b bg-slate-100 uppercase py-1.5">
                      {[...Array(4)].map((_, i) => (
                        <span key={i} className="contents">
                          <div className="border-r border-slate-200">E</div>
                          <div className="border-r border-slate-200">Δ</div>
                          <div className="border-r border-slate-200 last:border-0">M</div>
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="grid grid-cols-12 text-center items-center">
                      {digits.map((digit, i) => {
                        ...
                        return (
                          <div 
                            key={i} 
                            className={`py-5 text-xl md:text-2xl font-black border-r border-slate-200 last:border-0 transition-all duration-200 
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {presets.map((item, idx) => (
                        <button
                          ...
                          className="text-left px-3 py-2 bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-300 rounded-xl text-xs font-bold text-slate-700 transition shadow-sm"
                        >
                          {item.label}
                        </button>
                      ))}
