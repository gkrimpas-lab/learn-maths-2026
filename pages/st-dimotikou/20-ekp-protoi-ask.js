...
export default function EkpProtoiExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Ε.Κ.Π. με Πρώτους Παράγοντες - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στο Ε.Κ.Π. με ανάλυση σε γινόμενο πρώτων παραγόντων για τη ΣΤ' Δημοτικού." />
