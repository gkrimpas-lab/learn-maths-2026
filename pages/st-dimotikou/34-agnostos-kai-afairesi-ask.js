...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Ο μειωτέος είναι το αρχικό σύνολο, άρα προκύπτει προσθέτοντας τη διαφορά και τον αφαιρετέο: x ＝ β ＋ α.'
        : 'Για να βρούμε τον μειωτέο κάνουμε πρόσθεση (x ＝ β ＋ α).'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Επειδή από τον μειωτέο αφαιρούμε ποσότητα, είναι πάντα μεγαλύτερος από τη διαφορά και τον αφαιρετέο.'
        : 'Ο μειωτέος είναι το άθροισμα των άλλων δύο όρων, άρα είναι ο μεγαλύτερος αριθμός.'
    },
    q7: {
      type: 'input',
...
export default function AgnostosKaiAfairesiExercisesPage() {
  ...
  return (
    <Layout
      title="🎯 Ασκήσεις: 34. Άγνωστος Μειωτέος - ΣΤ' Δημοτικού | LearnMaths.gr"
      description="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην επίλυση εξισώσεων με άγνωστο μειωτέο (x - α = β) για τη ΣΤ' Δημοτικού."
