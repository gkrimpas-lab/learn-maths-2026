        ...
        <main className={`${LAYOUT.LESSON_CONTAINER} 2xl:max-w-7xl py-8 md:py-12 space-y-10 2xl:space-y-14`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 2xl:gap-8">
            <div className="bg-blue-50/80 border border-blue-100 p-6 2xl:p-8 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              <div className="space-y-2.5">
                ...
                <h3 className="text-lg 2xl:text-xl font-black text-slate-900">Τι είναι ο Μ.Κ.Δ.;</h3>
            ...
            <div className="bg-indigo-50/80 border border-indigo-100 p-6 2xl:p-8 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              <div className="space-y-2.5">
                ...
                <h3 className="text-lg 2xl:text-xl font-black text-slate-900">Πώς τον βρίσκουμε;</h3>
                <p className="text-slate-600 text-sm 2xl:text-base leading-relaxed">
            ...
            <div className="bg-cyan-50/80 border border-cyan-100 p-6 2xl:p-8 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              <div className="space-y-2.5">
                ...
                <h3 className="text-lg 2xl:text-xl font-black text-slate-900">Πρώτοι μεταξύ τους</h3>
                <p className="text-slate-600 text-sm 2xl:text-base leading-relaxed">
          ...
          <div className="bg-white p-6 md:p-8 2xl:p-10 rounded-3xl border border-gray-200 shadow-sm space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full text-xl font-mono font-black text-center p-2.5 bg-white border-2 border-blue-300 rounded-xl text-blue-600 outline-none focus:border-blue-500 shadow-sm"
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full text-xl font-mono font-black text-center p-2.5 bg-white border-2 border-indigo-300 rounded-xl text-indigo-600 outline-none focus:border-indigo-500 shadow-sm"
                      />
                    </div>
                    {activeTab >= 3 && (
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full text-xl font-mono font-black text-center p-2.5 bg-white border-2 border-purple-300 rounded-xl text-purple-600 outline-none focus:border-purple-500 shadow-sm"
                        />
                      </div>
                    )}
                    {activeTab === 4 && (
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full text-xl font-mono font-black text-center p-2.5 bg-white border-2 border-pink-300 rounded-xl text-pink-600 outline-none focus:border-pink-500 shadow-sm"
                        />
                      </div>
                    )}
                  </div>
              ...
              <div className="lg:col-span-8 bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between min-h-[460px] space-y-6">
                
                {/* DIVISORS LISTS FOR EACH NUMBER */}
                <div className="w-full space-y-3">
                  {numbersList.map((numObj, index) => (
                    <div key={index} className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-1.5 shadow-xs">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {numObj.div.map(d => {
                          ...
                          return (
                            <span
                              key={d}
                              className={`font-mono font-black px-3 py-1 text-xs rounded-xl border transition-all ${
                                isMkd
                                  ? 'bg-amber-400 border-amber-500 text-slate-900 shadow-md scale-105 ring-2 ring-amber-300'
                                  : isCommon
                ...
                {/* VISUAL SEGMENT BARS */}
                <div className="w-full bg-slate-900 text-white p-5 rounded-2xl border border-slate-800 space-y-4 shadow-md">
                ...
                {/* FINAL RESULT BADGE */}
                <div className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white p-4 rounded-2xl text-center shadow-lg font-mono font-black flex items-center justify-center gap-3">
                  <span className="text-2xl">🏆</span>
                  <span className="text-xs md:text-sm font-sans uppercase tracking-wider">Μέγιστος Κοινός Διαιρέτης:</span>
                  <span className="text-xl md:text-2xl bg-white/20 px-4 py-1 rounded-xl shadow-inner">
