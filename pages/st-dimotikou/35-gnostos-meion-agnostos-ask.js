  ...
  return {
    ...
    q5: {
      ...
      explain: q5IsTrue
        ...
        : 'Λάθος! Για να βρούμε τον αφαιρετέο κάνουμε ΑΦΑΙΡΕΣΗ: x ＝ α － β.'
    },
    q6: {
      type: 'tf',
...
export default function GnostosMeionAgnostosExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Άγνωστος Αφαιρετέος (α - x = β) - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην επίλυση εξισώσεων με άγνωστο αφαιρετέο (α - x = β) για τη ΣΤ' Δημοτικού." />
          ...
          <div className={`${LAYOUT.CONTAINER} flex flex-col md:flex-row justify-between items-center gap-6`}>
            <div className="space-y-2 text-center md:text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-black tracking-tight">
                Διαδραστικές Ασκήσεις: Άγνωστος Αφαιρετέος ($\alpha - x = \beta$)
              </h1>
