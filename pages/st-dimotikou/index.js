...
export default function STDimotikouMenu() {
  const modules = [
    ...
    { id: '02-dekadikoi', label: '🏷️ 2. Δεκαδικοί Αριθμοί', href: '/st-dimotikou/02-dekadikoi' },
    ...
    { id: '04-sigkrisi-arithmon', label: '⚖️ 4. Σύγκριση Δεκαδικών Αριθμών', href: '/st-dimotikou/04-sigkrisi-arithmon' },
    { id: '05-prosthesi', label: '➕ 5. Πρόσθεση Φυσικών Αριθμών', href: '/st-dimotikou/05-prosthesi' },
    { id: '06-pollaplasiasmos', label: '✖️ 6. Πολλαπλασιασμός Φυσικών Αριθμών', href: '/st-dimotikou/06-pollaplasiasmos' },
    ...
    { id: '13-diairetes', label: '🛡️ 13. Διαιρέτες Αριθμού', href: '/st-dimotikou/13-diairetes' },
    ...
    { id: '20-ekp-protoi', label: '⚙️ 20. ΕΚΠ - Αλγόριθμος Πρώτοι Αριθμοί', href: '/st-dimotikou/20-ekp-protoi' },
    ...
    { id: '26-sigkrisi-klasmaton', label: '⚖️ 26. Σύγκριση Κλασμάτων', href: '/st-dimotikou/26-sigkrisi-klasmaton' },
    ...
    { id: '30-diairesi-klasmaton', label: '➗ 30. Διαίρεση Κλασμάτων', href: '/st-dimotikou/30-diairesi-klasmaton' },
    { id: '31-epanalipsi-1', label: '🏆 31. Επανάληψη ( Κεφ. 1 - 30 )', href: '/st-dimotikou/31-epanalipsi-1' },
    { id: '32-metabliti', label: '🧩 32. Μεταβλητή ( x )', href: '/st-dimotikou/32-metabliti' },
    ...
    { id: '49-antistrofos-analoga-posa', label: '📐 49. Μέθοδος των τριών - Αντιστρόφως ανάλογα ποσά', href: '/st-dimotikou/49-antistrofos-analoga-posa' },
    ...
    { id: '57-alla-grafimata', label: '📐 57. Άλλοι τύποι γραφημάτων', href: '/st-dimotikou/57-alla-grafimata' },
  ];
