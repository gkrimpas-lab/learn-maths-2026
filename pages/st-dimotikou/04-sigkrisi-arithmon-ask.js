...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? `Ο αριθμός ${formatNumber(q5Big)} έχει 5 ψηφία (Δεκάδες Χιλιάδων), ενώ ο ${formatNumber(q5Small)} έχει 4 ψηφία (Μονάδες Χιλιάδων).`
        : `Στους φυσικούς αριθμούς, μεγαλύτερος είναι πάντα εκείνος με τα περισσότερα ψηφία (${formatNumber(q5Big)} ＞ ${formatNumber(q5Small)}).`
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Συγκρίνουμε διαδοχικά από τα αριστερά προς τα δεξιά (πρώτα δέκατα, μετά εκατοστά, μετά χιλιοστά).'
        : '0,8 = 0,80 (80 εκατοστά), το οποίο είναι μεγαλύτερο από το 0,79 (79 εκατοστά).'
    },
    q7: {
      type: 'mcq',
