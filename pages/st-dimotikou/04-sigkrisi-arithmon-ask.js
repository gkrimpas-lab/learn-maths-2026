...
function generateQuestions() {
  ...
  const q7Item = shuffledItems[0].item;
...
export default function SigkrisiExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Σύγκριση & Διάταξη Αριθμών - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στη σύγκριση φυσικών και δεκαδικών αριθμών για τη ΣΤ' Δημοτικού." />
        ...
        <main className={`${LAYOUT.LESSON_CONTAINER} py-10`}>
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* ΕΡΩΤΗΣΗ 1: MCQ (Σύγκριση Δεκαδικών) */}
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q1')}`}>
                ...
                <div className="p-3.5 bg-slate-100 rounded-2xl font-mono text-xl text-center font-black text-slate-800 mb-4 flex items-center justify-center gap-4">
                  <span className="text-emerald-700">{questions.q1.numA}</span>
                  <span className="bg-white border border-slate-300 px-3 py-1 rounded-xl text-blue-600 shadow-sm min-w-[48px]">
                    {answers.q1 || '?'}
                  </span>
                ...
                <div className="grid grid-cols-3 gap-2 mb-3">
                  {questions.q1.options.map((opt, idx) => (
                    <button
                      ...
                      className={`p-3 rounded-xl text-lg font-black border text-center transition ${
                        answers.q1 === opt
              ...
              {/* ΕΡΩΤΗΣΗ 2: MCQ (Ισοδύναμοι Δεκαδικοί) */}
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q2')}`}>
                ...
                <div className="p-3.5 bg-slate-100 rounded-2xl font-mono text-xl text-center font-black text-slate-800 mb-4 flex items-center justify-center gap-4">
                  ...
                  <span className="bg-white border border-slate-300 px-3 py-1 rounded-xl text-indigo-600 shadow-sm min-w-[48px]">
                    {answers.q2 || '?'}
                  </span>
              ...
              {/* ΕΡΩΤΗΣΗ 3: Input (Εύρεση Μεγαλύτερου) */}
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q3')}`}>
                ...
                <div className="p-3 bg-slate-100 rounded-xl font-mono text-sm text-center font-black text-slate-800 mb-4">
                  {questions.q3.list}
                </div>
              ...
              {/* ΕΡΩΤΗΣΗ 5: True/False (Πλήθος Ψηφίων σε Φυσικούς) */}
              ...
              {/* ΕΡΩΤΗΣΗ 6: True/False (Σύγκριση Δεκαδικών) */}
              ...
              {/* ΕΡΩΤΗΣΗ 7: Οπτικό SVG (Ζυγαριά Σύγκρισης) */}
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q7')}`}>
                ...
                <div className="bg-slate-100 rounded-2xl p-4 mb-4 flex justify-center">
                  <svg viewBox="0 0 300 120" className="w-full max-w-xs h-24">
              ...
              {/* ΕΡΩΤΗΣΗ 8: Οπτικό SVG (Αριθμογραμμή) */}
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q8')}`}>
                ...
                {/* SVG Number Line with 2 Points */}
                <div className="bg-slate-100 p-3 rounded-2xl mb-3 flex items-center justify-center">
                  <svg viewBox="0 0 300 70" className="w-full max-w-sm h-18">
