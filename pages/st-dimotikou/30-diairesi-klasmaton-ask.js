...
function generateQuestions() {
  ...
  const scWrongs = [
    ...
    `${sc.totalN * sc.portionN}/${sc.totalD * sc.portionD} ${sc.resultText}`,
...
export default function DiairesiKlasmatonExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Διαίρεση Κλασμάτων - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στη διαίρεση κλασμάτων, ακεραίων και σύνθετων κλασμάτων για τη ΣΤ' Δημοτικού." />
