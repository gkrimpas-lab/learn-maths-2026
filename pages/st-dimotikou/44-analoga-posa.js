            ...
            <article className="bg-white p-5 sm:p-7 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-5">
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[11px] sm:text-xs 2xl:text-sm font-semibold text-slate-500">Σταθερός Λόγος</span>
                </div>
                <h3 className="text-base sm:text-xl 2xl:text-2xl font-black text-slate-900">
                ...
                <div className="bg-slate-50 p-3 sm:p-4 rounded-2xl border border-slate-200 space-y-1.5 text-xs sm:text-sm text-center">
                  <div className="flex items-center justify-center text-sm sm:text-base font-bold text-amber-900">
                    <Fraction num="ψ" den="χ" />
                    <span className="mx-2">＝</span>
                    <span className="font-mono font-black text-lg sm:text-xl text-amber-800">λ</span>
                    <span className="mx-2">ή</span>
                    <span className="font-mono font-black text-lg sm:text-xl text-amber-800">ψ ＝ λ · χ</span>
                  </div>
            ...
            <article className="bg-white p-5 sm:p-7 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-5">
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="bg-slate-50 p-2.5 sm:p-3 rounded-2xl border border-slate-200 font-mono text-xs space-y-1.5">
                  ...
                  <div className="text-[10.5px] text-slate-500 text-center pt-0.5 font-sans">
            ...
            <article className="bg-white p-5 sm:p-7 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-5">
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-1.5 text-xs sm:text-sm">
                  <div className="p-2 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-950 font-bold text-center text-xs">
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-md p-4 sm:p-8 2xl:p-12 space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="bg-amber-50/70 p-4 sm:p-5 rounded-2xl border border-amber-200 space-y-2.5">
                <div className="flex items-center justify-between">
                  <span className="text-[11px] sm:text-xs font-black uppercase text-amber-900 tracking-wider">
                    ΣΥΝΤΕΛΕΣΤΗΣ ΑΝΑΛΟΓΙΑΣ (λ)
                  </span>
                  <span className="font-mono font-black text-base sm:text-lg text-amber-800 bg-white px-2.5 py-0.5 rounded-lg border border-amber-200">
                    λ ＝ {formatNum(lambda)}
                  </span>
                </div>
              ...
              <div className="bg-blue-50/70 p-3.5 sm:p-4 rounded-2xl border border-blue-200 space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono font-black text-base sm:text-lg text-blue-800 bg-white px-2 py-0.5 rounded-lg border border-blue-200">
                    χ ＝ {selectedKg}
                  </span>
                </div>
                <div className="grid grid-cols-[34px_1fr_34px] items-center h-10 w-full gap-2">
                ...
                <div className="pt-1 text-center font-bold text-slate-800 text-xs sm:text-sm">
                  Υπολογισμός: ψ ＝ {formatNum(lambda)} · {selectedKg} ＝ <span className="font-mono text-emerald-700 text-sm sm:text-base">{formatNum(currentCost)}</span>
                </div>
              </div>

            </div>

            {/* Πινακας Τιμων & Πηλικων - Fluid & Responsive */}
            <div className="lg:col-span-7 bg-slate-50 p-4 sm:p-6 rounded-3xl border border-slate-200 space-y-3 sm:space-y-4 w-full">
              ...
              <div className="w-full overflow-hidden bg-white rounded-2xl border border-slate-200 shadow-sm text-center text-xs font-mono">
                <div className="grid grid-cols-4 sm:grid-cols-6 bg-slate-100 border-b border-slate-200 text-slate-700 font-bold p-2">
                  <span className="text-left font-sans truncate">Ποσό χ (kg)</span>
                  {tableValues.slice(0, 3).map((item) => (
                    <span key={`head-x-sm-${item.x}`} className="sm:hidden">
                      {item.x}
                    </span>
                  ))}
                  {tableValues.map((item) => (
                    <span key={`head-x-${item.x}`} className="hidden sm:inline">
                      {item.x}
                    </span>
                  ))}
                </div>
                <div className="grid grid-cols-4 sm:grid-cols-6 border-b border-slate-100 text-indigo-900 font-bold p-2">
                  <span className="text-left font-sans text-slate-600 truncate">Ποσό ψ (€)</span>
                  {tableValues.slice(0, 3).map((item) => (
                    <span key={`body-y-sm-${item.x}`} className="sm:hidden text-indigo-700 font-black">
                      {formatNum(item.y)}
                    </span>
                  ))}
                  {tableValues.map((item) => (
                    <span key={`body-y-${item.x}`} className="hidden sm:inline text-indigo-700 font-black">
                      {formatNum(item.y)}
                    </span>
                  ))}
                </div>
                <div className="grid grid-cols-4 sm:grid-cols-6 bg-amber-50/50 text-amber-950 font-bold p-2">
                  <span className="text-left font-sans text-slate-600 truncate">Λόγος (ψ : χ)</span>
                  {tableValues.slice(0, 3).map((item) => (
                    <span key={`body-ratio-sm-${item.x}`} className="sm:hidden text-amber-800">
                      {item.ratio}
                    </span>
                  ))}
                  {tableValues.map((item) => (
                    <span key={`body-ratio-${item.x}`} className="hidden sm:inline text-amber-800">
                      {item.ratio}
                    </span>
                  ))}
                </div>
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-md p-4 sm:p-8 2xl:p-12 space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
            ...
            <div className="lg:col-span-5 space-y-3.5">
              ...
              <div className="bg-emerald-50/70 p-3.5 rounded-2xl border border-emerald-200 text-xs sm:text-sm text-emerald-950">
            ...
            {/* SVG Διαγραμμα Αξονων - Fluid & Responsive Χωρις Scroll */}
