...
export default function StroggilopoiisiPage() {
  ...
  return (
    <Layout
      title="🎯 12. Στρογγυλοποίηση Φυσικών και Δεκαδικών Αριθμών - LearnMaths.gr"
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 rounded-3xl p-6 md:p-10 text-white shadow-xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl flex flex-col items-center text-center space-y-3 shadow-inner">
              ...
              <p className="text-xs text-blue-50">Δοκίμασε τις διαδραστικές ασκήσεις με άμεσο έλεγχο και βαθμολόγηση!</p>
              <Link
                href="/st-dimotikou/12-stroggilopoiisi-ask"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-blue-50/80 border border-blue-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-2.5">
              ...
              <h3 className="text-lg font-black text-slate-900">Τι είναι η Στρογγυλοποίηση;</h3>
          ...
          <div className="bg-rose-50/80 border border-rose-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-2.5">
              <div className="w-10 h-10 bg-rose-600 text-white rounded-2xl flex items-center justify-center font-black text-lg shadow-sm">
                2
              </div>
              <h3 className="text-lg font-black text-slate-900">Στρογγυλοποίηση Κάτω</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Αν το αμέσως επόμενο ψηφίο είναι <strong>0, 1, 2, 3 ή 4</strong>, το ψηφίο της τάξης παραμένει <strong>ίδιο</strong>.
              </p>
            </div>
            <div className="bg-white p-3.5 rounded-2xl border border-rose-100 text-xs text-slate-700 font-mono text-center font-bold">
          ...
          <div className="bg-emerald-50/80 border border-emerald-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
            <div className="space-y-2.5">
              ...
              <h3 className="text-lg font-black text-slate-900">Στρογγυλοποίηση Πάνω</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="flex flex-wrap gap-2 w-full md:w-auto">
              {presets.map((preset, idx) => (
                <button
                  ...
                  className="bg-slate-100 hover:bg-blue-50 hover:text-blue-600 text-slate-700 text-xs font-bold px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-slate-200 transition shadow-xs"
                >
                  {preset.label}
                </button>
              ))}
                ...
                <div className="space-y-2 pt-2 border-t border-slate-200">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className={`px-3 py-2 rounded-xl border font-bold text-xs transition-all text-left truncate ${
              ...
              <div className="w-full max-w-xl mx-auto my-auto py-10 sm:py-12 px-4 sm:px-6">
                <div className="h-3 bg-gradient-to-r from-rose-200 via-amber-200 to-emerald-200 rounded-full relative shadow-inner">
                  ...
                  <div className="absolute left-0 top-4 text-center -translate-x-1/2 mt-1">
                    <span className="text-[9px] text-slate-400 font-bold uppercase tracking-tight whitespace-nowrap">Κάτω Όριο</span>
                  </div>
                  ...
                  <div className="absolute right-0 top-4 text-center translate-x-1/2 mt-1">
                    <span className="text-[9px] text-slate-400 font-bold uppercase tracking-tight whitespace-nowrap">Πάνω Όριο</span>
                  </div>
                ...
                <div className="mt-14 sm:mt-16 flex flex-col sm:flex-row justify-between items-center w-full bg-slate-50 rounded-2xl p-3.5 sm:p-4 border border-slate-200 font-medium gap-3 sm:gap-2">
                  ...
                  <div className="flex-1 flex flex-col items-center text-center">
                    <span className={`text-xs font-black px-3 py-1 rounded-full uppercase tracking-wider ${isUp ? 'bg-emerald-100 text-emerald-800' : 'bg-rose-100 text-rose-800'}`}>
