...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Σωστά! Ο Μ.Κ.Δ. είναι ο μεγαλύτερος από όλους τους κοινούς διαιρέτες δύο ή περισσότερων αριθμών.'
        : 'Λάθος! Ο Μ.Κ.Δ. είναι ο μεγαλύτερος κοινός διαιρέτης, όχι το γινόμενο.'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Σωστά! Δύο αριθμοί λέγονται πρώτοι μεταξύ τους όταν έχουν Μ.Κ.Δ. ίσο με 1.'
...
export default function MkdExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Μέγιστος Κοινός Διαιρέτης (Μ.Κ.Δ.) - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στον Μέγιστο Κοινό Διαιρέτη για τη ΣΤ' Δημοτικού." />
                ...
                <div className="space-y-2 mb-3">
                  {questions.q3.options.map((opt, idx) => (
                    <button
                      ...
                      className={`w-full p-2.5 rounded-xl text-xs font-mono font-bold border text-left transition ${
                        answers.q3 === opt
