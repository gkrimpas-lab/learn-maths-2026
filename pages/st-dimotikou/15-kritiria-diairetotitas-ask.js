...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Για το 3 και το 9 αρκεί να προσθέσουμε τα ψηφία του αριθμού.'
        : 'Για τη διαιρετότητα με το 9 εξετάζουμε το ΑΘΡΟΙΣΜΑ των ψηφίων, όχι μόνο το τελευταίο ψηφίο.'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Τα δύο τελευταία ψηφία πρέπει να σχηματίζουν 00, 25, 50 ή 75.'
        : 'Δεν αρκεί το τελευταίο ψηφίο να είναι 5 (π.χ. το 15 λήγει σε 5 αλλά ΔΕΝ διαιρείται με το 25).'
    },
    q7: {
      type: 'input',
...
export default function KritiriaDiairetotitasExercisesPage() {
  ...
  return (
    <Layout
      ...
      description="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στα κριτήρια διαιρετότητας για τη ΣΤ' Δημοτικού."
