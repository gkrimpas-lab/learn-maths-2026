...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Σωστά! Όταν το επόμενο ψηφίο είναι 5, 6, 7, 8 ή 9, αυξάνουμε το ψηφίο της επιθυμητής τάξης κατά 1.'
        : 'Λάθος! Όταν το επόμενο ψηφίο είναι 5, 6, 7, 8 ή 9, το ψηφίο αυξάνεται κατά 1.'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Σωστά! Μετά τη στρογγυλοποίηση, όλα τα ψηφία στα δεξιά μηδενίζονται (ή παραλείπονται στα δεκαδικά).'
...
export default function StroggilopoiisiExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Στρογγυλοποίηση Αριθμών - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στη στρογγυλοποίηση φυσικών και δεκαδικών αριθμών για τη ΣΤ' Δημοτικού." />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q7')}`}>
                ...
                <div className="bg-slate-100 rounded-2xl p-4 mb-4 flex justify-center">
                  <svg viewBox="0 0 300 70" className="w-full max-w-xs h-16">
