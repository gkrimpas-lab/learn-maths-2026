...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Σωστά! Το 1 είναι το ουδέτερο στοιχείο του πολλαπλασιασμού και το 0 είναι το απορροφητικό στοιχείο.'
    ...
    q6: {
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Σωστά! Ο παράγοντας έξω από την παρένθεση πολλαπλασιάζεται ξεχωριστά με κάθε προσθετέο μέσα σε αυτή.'
...
export default function PollaplasiasmosExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Πολλαπλασιασμός & Ιδιότητες - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στον πολλαπλασιασμό φυσικών αριθμών και τις ιδιότητες για τη ΣΤ' Δημοτικού." />
          ...
          <div className={`${LAYOUT.CONTAINER} flex flex-col md:flex-row justify-between items-center gap-6`}>
            <div className="space-y-2 text-center md:text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-black tracking-tight">
                Διαδραστικές Ασκήσεις: Πολλαπλασιασμός & Ιδιότητες
              </h1>
        ...
        <main className={`${LAYOUT.LESSON_CONTAINER} py-10`}>
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* ΕΡΩΤΗΣΗ 1: Input (Υπολογισμός Γινομένου) */}
              ...
              {/* ΕΡΩΤΗΣΗ 2: Input (Επιμεριστική Ιδιότητα) */}
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q2')}`}>
                ...
                <div className="p-3 bg-slate-100 rounded-2xl font-mono text-lg md:text-xl text-center font-black text-slate-800 mb-4">
              ...
              {/* ΕΡΩΤΗΣΗ 5: True/False (Ουδέτερο & Απορροφητικό) */}
              ...
              {/* ΕΡΩΤΗΣΗ 6: True/False (Επιμεριστική Ιδιότητα) */}
              ...
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q7')}`}>
                ...
                <div className="bg-slate-100 rounded-2xl p-4 mb-4 flex justify-center">
                  <svg 
                    ...
                    className="max-w-xs h-24 bg-white rounded-lg border border-slate-300 shadow-sm p-1"
                  >
              ...
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q8')}`}>
                ...
                <div className="bg-slate-100 p-3 rounded-2xl mb-3 flex items-center justify-center">
                  <div className="flex w-64 h-20 rounded-xl overflow-hidden border-2 border-slate-700 shadow-sm text-white font-mono font-bold text-xs">
                    <div 
                      className="bg-emerald-500 flex flex-col items-center justify-center transition-all"
                    ...
                    <div 
                      className="bg-cyan-500 flex flex-col items-center justify-center transition-all border-l-2 border-dashed border-white/60"
