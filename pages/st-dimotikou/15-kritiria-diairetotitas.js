          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 2xl:gap-8">
            <div className="bg-blue-50/80 border border-blue-100 p-6 2xl:p-8 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              <div className="space-y-2.5">
                ...
                <h3 className="text-lg 2xl:text-xl font-black text-slate-900">Τελευταίο Ψηφίο (2, 5, 10)</h3>
            ...
            <div className="bg-indigo-50/80 border border-indigo-100 p-6 2xl:p-8 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              <div className="space-y-2.5">
                ...
                <h3 className="text-lg 2xl:text-xl font-black text-slate-900">Άθροισμα Ψηφίων (3 & 9)</h3>
                <p className="text-slate-600 text-sm 2xl:text-base leading-relaxed">
            ...
            <div className="bg-cyan-50/80 border border-cyan-100 p-6 2xl:p-8 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              <div className="space-y-2.5">
                ...
                <h3 className="text-lg 2xl:text-xl font-black text-slate-900">Δύο Τελευταία Ψηφία (4 & 25)</h3>
                <p className="text-slate-600 text-sm 2xl:text-base leading-relaxed">
                ...
                <div className="w-full space-y-3.5 my-auto">
                  {numberStr ? (
                    criteria.map((c) => (
                      <div
                        key={c.check}
                        className="p-4 rounded-2xl border border-slate-200 bg-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all hover:border-slate-300 shadow-xs"
                      >
