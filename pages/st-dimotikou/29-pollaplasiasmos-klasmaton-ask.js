...
const REAL_WORLD_SCENARIOS = [
  { item: 'της πίτσας', who: 'Ο Νίκος πήρε το', n1: 1, d1: 2, sub: 'και από αυτό έφαγε τα', n2: 2, d2: 3 },
  { item: 'του οικοπέδου', who: 'Ο κηπουρός καθάρισε τα', n1: 3, d1: 4, sub: 'και από αυτά φύτεψε τα', n2: 2, d2: 5 },
  { item: 'του χυμού', who: 'Η κανάτα περιείχε τα', n1: 2, d1: 3, sub: 'και ήπιαμε το', n2: 1, d2: 4 },
  { item: 'της διαδρομής', who: 'Διανύσαμε τα', n1: 4, d1: 5, sub: 'και σε αυτά τρέξαμε τα', n2: 1, d2: 2 }
];
...
function generateQuestions() {
  ...
  const scResN = sc.n1 * sc.n2;
  const scResD = sc.d1 * sc.d2;
  ...
  return {
    ...
    q5: {
      ...
      explain: q5IsTrue
        ...
        : 'Λάθος! Στον πολλαπλασιασμό ΔΕΝ χρειάζεται να κάνουμε τα κλάσματα ομώνυμα.'
    },
    q6: {
      type: 'tf',
      ...
      explain: q6IsTrue
        ...
        : 'Λάθος! Το γινόμενο γνήσιων κλασμάτων είναι πάντοτε μικρότερο και από τα δύο (π.χ. 1/2 × 1/2 = 1/4 < 1/2).'
    },
    q7: {
      type: 'input',
    ...
    q8: {
      ...
      prompt: `${sc.who} ${sc.n1}/${sc.d1} ${sc.item} ${sc.sub} ${sc.n2}/${sc.d2}. Ποιο μέρος ${sc.item} χρησιμοποιήθηκε συνολικά;`,
      options: q8Options,
      correct: scCorrectStr,
      explain: `Πολλαπλασιάζουμε τα δύο κλάσματα: (${sc.n1}/${sc.d1}) × (${sc.n2}/${sc.d2}) ＝ ${scResN}/${scResD}${scG > 1 ? ` ＝ ${scCorrectStr}` : ''}.`
    }
  };
}
...
export default function PollaplasiasmosKlasmatonExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Πολλαπλασιασμός Κλασμάτων - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στον πολλαπλασιασμό κλασμάτων και ακεραίων για τη ΣΤ' Δημοτικού." />
