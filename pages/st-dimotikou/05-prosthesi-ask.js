...
export default function ProsthesiExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Πρόσθεση & Ιδιότητες - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην πρόσθεση φυσικών και δεκαδικών αριθμών για τη ΣΤ' Δημοτικού." />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className={`p-6 rounded-3xl border transition-all ${getCardStyle('q2')}`}>
                ...
                <div className="p-3 bg-slate-100 rounded-2xl font-mono text-xl text-center font-black text-slate-800 mb-4">
                  ...
                  <span className="text-slate-400 mx-2">＋</span>
                  <span className="text-amber-600 bg-white px-2 py-0.5 rounded-lg border border-slate-300">?</span>
                  <span className="text-slate-400 mx-2">＝</span>
