...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Η στοίχιση των υποδιαστολών εξασφαλίζει ότι προσθέτουμε ομώνυμες τάξεις (δέκατα με δέκατα, μονάδες με μονάδες).'
        : 'Στους δεκαδικούς αριθμούς στοιχίζουμε πάντα τις υποδιαστολές, όχι τα τελευταία ψηφία.'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? `Η αφαίρεση είναι η αντίστροφη πράξη της πρόσθεσης: ${q6Sum} － ${q6B} ＝ ${q6A}.`
        : 'Η δοκιμή της πρόσθεσης γίνεται με αφαίρεση ενός προσθετέου από το άθροισμα.'
    },
    q7: {
      type: 'input',
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="space-y-2 text-center md:text-left">
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight leading-tight">
                Διαδραστικές Ασκήσεις: Πρόσθεση και Ιδιότητες
              </h1>
