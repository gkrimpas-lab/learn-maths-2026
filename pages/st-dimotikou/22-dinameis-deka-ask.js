...
export default function DinameisDekaExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Οι Δυνάμεις του 10 - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στις δυνάμεις του 10 και τη σύντομη γραφή μεγάλων αριθμών για τη ΣΤ' Δημοτικού." />
