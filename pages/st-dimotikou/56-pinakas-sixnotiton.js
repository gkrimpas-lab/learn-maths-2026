...
export default function PinakasSixnotitonTheoryPage() {
  ...
  const tableRows = useMemo(() => {
    const rawData = [
      { label: 'Βαθμός 10', freq: freqA, color: '#10b981' },
      { label: 'Βαθμός 9', freq: freqB, color: '#3b82f6' },
      { label: 'Βαθμός 8', freq: freqC, color: '#f59e0b' },
      { label: 'Βαθμός 7', freq: freqD, color: '#ec4899' }
    ];
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Διαλογή</span>
                </div>
                ...
                <div className="bg-slate-50 p-3.5 2xl:p-4 rounded-2xl border border-slate-200 text-xs sm:text-sm space-y-1.5 font-mono">
                  <div className="text-slate-500 font-sans text-xs">Άτακτα δεδομένα:</div>
                  <div className="font-bold text-slate-800">10, 9, 8, 9, 10, 9, 7, 8, 9</div>
                  <div className="text-slate-500 font-sans text-xs pt-1">Ταξινόμηση σε αύξουσα σειρά:</div>
                  <div className="font-bold text-blue-700">7, 8, 8, 9, 9, 9, 9, 10, 10</div>
                </div>
              </div>
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Πίνακας</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
                  Πίνακας Συχνοτήτων
                </h3>
              ...
              <div className="p-3.5 bg-amber-50 rounded-2xl border border-amber-200 text-xs 2xl:text-sm text-amber-950 font-medium">
                ⚡ Αν αθροίσουμε όλες τις συχνότητες, πρέπει υποχρεωτικά να βρούμε το συνολικό πλήθος των μαθητών ή μετρήσεων.
              </div>
            </article>
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Αναλογία</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
                  Σχετική Συχνότητα &amp; %
                </h3>
                ...
                <div className="bg-slate-50 p-3.5 2xl:p-4 rounded-2xl border border-slate-200 space-y-2 text-xs sm:text-sm font-mono text-center">
                  <div className="p-2 bg-white rounded-xl border border-slate-200 text-indigo-950 font-bold">
                    Σχετική Συχνότητα ＝ <Fraction num="Συχνότητα (ν)" den="Σύνολο (Ν)" />
                  </div>
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Συμπεράσματα</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-6">
            <div>
              ...
              <p className="text-slate-600 text-xs sm:text-sm 2xl:text-base mt-0.5">
                Μεταβάλλετε τις συχνότητες των 4 βαθμολογιών ανά 1 μαθητή και παρατηρήστε πώς υπολογίζονται αυτόματα το σύνολο, οι σχετικές συχνότητες, τα ποσοστά και η επικρατούσα τιμή.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 space-y-3.5">
              ...
              <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-800 flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-emerald-500"></span> Βαθμός 10
                  </span>
              ...
              <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-800 flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-blue-500"></span> Βαθμός 9
                  </span>
              ...
              <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-800 flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-amber-500"></span> Βαθμός 8
                  </span>
              ...
              <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-800 flex items-center gap-2">
                    <span className="w-3 h-3 rounded-full bg-pink-500"></span> Βαθμός 7
                  </span>
            ...
            <div className="lg:col-span-7 bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-200 pb-2">
                ...
                <span className="text-xs font-bold text-slate-700 bg-white px-2.5 py-1 rounded-lg border border-slate-200">
                  Σύνολο (Ν): <strong className="font-mono text-blue-700">{totalN}</strong>
                </span>
              </div>

              <div className="overflow-x-auto">
                <table className="w-full bg-white rounded-2xl border border-slate-200 text-center text-xs sm:text-sm font-mono overflow-hidden shadow-sm">
                  <thead>
                    <tr className="bg-slate-100 border-b border-slate-200 text-slate-700 font-bold font-sans">
                      <th className="p-3 text-left">Τιμή (Βαθμός)</th>
                      <th className="p-3">Συχνότητα (ν)</th>
                      <th className="p-3">Σχετική Συχνότητα</th>
                      <th className="p-3">Ποσοστό (%)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {tableRows.map((r, idx) => (
                      <tr key={`tr-${idx}`} className="border-b border-slate-100 hover:bg-slate-50 transition">
                        <td className="p-3 text-left font-bold font-sans flex items-center gap-2">
                          <span className="w-2.5 h-2.5 rounded-full" style={{ backgroundColor: r.color }}></span>
                          {r.label}
                        </td>
                        <td className="p-3 font-black text-slate-900">{r.freq}</td>
                        <td className="p-3 text-slate-600">{formatNum(r.relFreq, 2)}</td>
                        <td className="p-3 font-bold text-emerald-700">{formatNum(r.pct)} %</td>
                      </tr>
                    ))}
                    <tr className="bg-slate-100/70 font-black text-slate-900 font-sans">
                      <td className="p-3 text-left">ΣΥΝΟΛΟ</td>
                      <td className="p-3 font-mono">{totalN}</td>
                      <td className="p-3 font-mono">1,00</td>
                      <td className="p-3 font-mono text-emerald-800">100 %</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="p-3.5 bg-blue-50/80 rounded-2xl border border-blue-200 text-xs sm:text-sm text-blue-950 flex items-center justify-between gap-2">
                <span>
                  🌟 <strong>Επικρατούσα Τιμή (Μόδα):</strong> {maxFreqRow ? maxFreqRow.label : '-'} (με συχνότητα {maxFreqRow ? maxFreqRow.freq : 0}).
                </span>
                <span className="font-bold text-blue-800 text-xs shrink-0">
                  {maxFreqRow ? `${formatNum(maxFreqRow.pct)} % των μαθητών` : ''}
                </span>
              </div>
            </div>
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-md p-6 sm:p-8 2xl:p-12 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
            ...
            <button
              ...
              className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold px-4 py-2 rounded-xl text-xs sm:text-sm shadow-sm transition active:scale-95 shrink-0 self-start sm:self-center"
            >
              🔄 Νέα Τυχαία Δεδομένα
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div className="lg:col-span-5 bg-slate-50 p-5 rounded-3xl border border-slate-200 space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                {rawSample.map((num, i) => (
                  <span
                    key={`raw-${i}`}
                    className="w-10 h-10 rounded-xl bg-white border border-slate-200 font-mono font-black text-lg text-slate-800 flex items-center justify-center shadow-sm"
                  >
                    {num}
                  </span>
                ))}
            ...
            {/* Πινακας Διαλογης με Tally Marks */}
            <div className="lg:col-span-7 bg-white p-5 rounded-3xl border-2 border-slate-200 shadow-sm space-y-3">
              <span className="text-xs font-bold text-slate-700 uppercase tracking-wider block text-center">
                ...
                <table className="w-full text-center text-xs sm:text-sm font-mono">
                  <thead>
                    <tr className="border-b border-slate-200 text-slate-600 font-bold font-sans">
                      ...
                      <th className="p-2">Γραμμές Καταμέτρησης</th>
                      <th className="p-2">Συχνότητα (ν)</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[1, 2, 3, 4].map((val) => {
                      ...
                      return (
                        <tr key={`tally-${val}`} className="border-b border-slate-100">
                          <td className="p-2.5 font-bold text-slate-900 font-sans">Τιμή {val}</td>
                          <td className="p-2.5 text-base tracking-widest text-blue-600 font-black">
                            {count > 0 ? '| '.repeat(count) : '-'}
                          </td>
                          <td className="p-2.5 font-black text-slate-900">{count}</td>
                        </tr>
                      );
                    })}
                  </tbody>
              ...
              <div className="text-xs text-slate-500 text-center font-sans pt-1">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <article className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              ...
              {/* ΠΙΝΑΚΑΣ ΠΑΡΑΔΕΙΓΜΑΤΟΣ 1 */}
              <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200">
                <table className="w-full text-center text-xs font-mono">
                  <thead>
                    <tr className="border-b border-slate-200 text-slate-600 font-bold font-sans">
                      <th className="p-1.5 text-left">Βαθμός</th>
                      <th className="p-1.5">Συχνότητα (ν)</th>
                      <th className="p-1.5">Σχετική Συχνότητα</th>
                      <th className="p-1.5">Ποσοστό (%)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-slate-100">
                      <td className="p-1.5 text-left font-sans font-bold">Βαθμός 10</td>
                      <td className="p-1.5 font-bold">5</td>
                      <td className="p-1.5">5/25 ＝ 0,20</td>
                      <td className="p-1.5 font-bold text-emerald-700">20 %</td>
                    </tr>
                    <tr className="border-b border-slate-100 bg-blue-50/50">
                      <td className="p-1.5 text-left font-sans font-bold text-blue-900">Βαθμός 9 (Μόδα)</td>
                      <td className="p-1.5 font-black text-blue-900">10</td>
                      <td className="p-1.5 text-blue-900 font-bold">10/25 ＝ 0,40</td>
                      <td className="p-1.5 font-black text-blue-900">40 %</td>
                    </tr>
                    <tr className="border-b border-slate-100">
                      <td className="p-1.5 text-left font-sans font-bold">Βαθμός 8</td>
                      <td className="p-1.5 font-bold">7</td>
                      <td className="p-1.5">7/25 ＝ 0,28</td>
                      <td className="p-1.5 font-bold text-emerald-700">28 %</td>
                    </tr>
                    <tr>
                      <td className="p-1.5 text-left font-sans font-bold">Βαθμός 7</td>
                      <td className="p-1.5 font-bold">3</td>
                      <td className="p-1.5">3/25 ＝ 0,12</td>
                      <td className="p-1.5 font-bold text-emerald-700">12 %</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="space-y-2 text-xs sm:text-sm font-mono pt-1">
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                  <span className="text-slate-500 font-sans block text-xs font-bold">Συμπεράσματα από τον Πίνακα:</span>
                  <div>• <strong>Επικρατούσα τιμή (Μόδα):</strong> Ο βαθμός 9 (σημειώθηκε από 10 μαθητές, δηλαδή το 40%).</div>
                  <div>• <strong>Μαθητές με βαθμό τουλάχιστον 9:</strong> 5 (με 10) ＋ 10 (με 9) ＝ <strong>15 μαθητές (60%)</strong>.</div>
                </div>
              </div>
            ...
            <article className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              ...
              {/* ΠΙΝΑΚΑΣ ΠΑΡΑΔΕΙΓΜΑΤΟΣ 2 */}
              <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200">
                <table className="w-full text-center text-xs font-mono">
                  <thead>
                    <tr className="border-b border-slate-200 text-slate-600 font-bold font-sans">
                      <th className="p-1.5 text-left">Ώρες Μελέτης</th>
                      <th className="p-1.5">Συχνότητα (ν)</th>
                      <th className="p-1.5">Σχετική Συχνότητα</th>
                      <th className="p-1.5">Ποσοστό (%)</th>
                    </tr>
                  ...
                  <tbody>
                    <tr className="border-b border-slate-100">
                      <td className="p-1.5 text-left font-sans font-bold">1 ώρα</td>
                      <td className="p-1.5 font-bold">4</td>
                      <td className="p-1.5">4/20 ＝ 0,20</td>
                      <td className="p-1.5 font-bold text-amber-800">20 %</td>
                    </tr>
                    <tr className="border-b border-slate-100 bg-amber-50/50">
                      <td className="p-1.5 text-left font-sans font-bold text-amber-950">2 ώρες (Μόδα)</td>
                      <td className="p-1.5 font-black text-amber-900">10</td>
                      <td className="p-1.5 text-amber-900 font-bold">10/20 ＝ 0,50</td>
                      <td className="p-1.5 font-black text-amber-900">50 %</td>
                    </tr>
                    <tr>
                      <td className="p-1.5 text-left font-sans font-bold">3 ώρες</td>
                      <td className="p-1.5 font-bold">6</td>
                      <td className="p-1.5">6/20 ＝ 0,30</td>
                      <td className="p-1.5 font-bold text-amber-800">30 %</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="space-y-2 text-xs sm:text-sm font-mono pt-1">
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                  <span className="text-slate-500 font-sans block text-xs font-bold">Συμπεράσματα από τον Πίνακα:</span>
                  <div>• <strong>Επικρατούσα τιμή:</strong> 2 ώρες (ακριβώς το 50% των μαθητών).</div>
                  <div>• <strong>Μαθητές που διαβάζουν πάνω από 1 ώρα:</strong> 10 ＋ 6 ＝ <strong>16 μαθητές (80%)</strong>.</div>
                </div>
              </div>

              <div className="p-3 bg-amber-50 rounded-xl border border-amber-200 text-xs text-amber-950 font-medium">
                💡 Το 80% των παιδιών διαβάζει από 2 ώρες και πάνω, γεγονός που αποτυπώνεται καθαρά στον πίνακα σχετικών συχνοτήτων.
              </div>
            </article>
