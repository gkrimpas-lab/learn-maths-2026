...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Οι πολλαπλασιασμοί και οι διαιρέσεις προηγούνται πάντα των προσθέσεων και αφαιρέσεων.'
        : 'Οι προσθέσεις και οι αφαιρέσεις γίνονται ΤΕΛΕΥΤΑΙΕΣ, εκτός αν βρίσκονται μέσα σε παρενθέσεις.'
    },
    q6: {
      type: 'tf',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Πράξεις με την ίδια προτεραιότητα εκτελούνται διαδοχικά από αριστερά προς τα δεξιά.'
        : 'Δεν προηγείται η πρόσθεση της αφαίρεσης. Εκτελούνται με τη σειρά που εμφανίζονται από αριστερά προς τα δεξιά.'
    },
    q7: {
      type: 'input',
...
export default function ProteraiotitaPrakseonExercisesPage() {
  ...
  return (
    <Layout
      ...
      description="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην προτεραιότητα των πράξεων για τη ΣΤ' Δημοτικού."
            ...
            <div className={`p-5 sm:p-6 rounded-3xl border transition-all ${getCardStyle('q2')}`}>
              <div className="flex justify-between items-center mb-4">
                <span className="text-xs font-black px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full">
                  Άσκηση 2 • Παράσταση με Παρένθεση
                </span>
                {submitted && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3">
                {questions.q3.options.map((opt, idx) => (
                  <button
                    ...
                    className={`p-3 rounded-xl text-xs sm:text-sm font-bold border text-left transition ${
                      answers.q3 === opt
