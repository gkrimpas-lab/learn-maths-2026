          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-indigo-50/80 border border-indigo-100 p-6 rounded-3xl space-y-4 flex flex-col justify-between shadow-sm">
              ...
              <div className="bg-white p-3.5 rounded-2xl border border-indigo-100 text-xs text-slate-700 font-mono text-center flex items-center justify-center gap-3">
                ...
                <span className="text-slate-400">➔</span>
                <span className="font-bold text-indigo-700">0,06</span>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="bg-white border border-slate-300 text-slate-700 w-8 h-8 rounded-lg font-black hover:bg-slate-100 transition flex items-center justify-center shadow-sm"
                            >
                              -
                            </button>
                            <input
                              ...
                              className="w-20 text-center font-black text-xl text-emerald-600 bg-white border border-slate-300 rounded-xl py-1 focus:border-emerald-500 outline-none shadow-sm font-mono"
                            />
                            <button
                              type="button"
                ...
                <div className="bg-gradient-to-br from-slate-900 to-indigo-950 text-white p-5 rounded-2xl space-y-3 shadow-md flex flex-col justify-center items-center text-center">
                  ...
                  {activeTab === 'toKlasma' ? (
                    <div className="flex items-center justify-center gap-4 text-2xl md:text-3xl font-black font-mono">
                      <span className="bg-white/10 px-4 py-2 rounded-xl text-white">
                        {dekadikos || "0"}
                      </span>
                      <span className="text-amber-400">➔</span>
                      <div className="inline-flex flex-col items-center leading-tight bg-white/10 px-4 py-1.5 rounded-xl">
                        <span className="text-emerald-400">{dynamicNum}</span>
                        <div className="w-14 h-[2px] bg-white my-1"></div>
                    ...
                    <div className="flex items-center justify-center gap-4 text-2xl md:text-3xl font-black font-mono">
                      ...
                      <span className="text-amber-400">➔</span>
                      <span className="bg-amber-400 text-slate-900 px-4 py-2 rounded-xl shadow-md">
              ...
              <div className="bg-slate-50 border border-slate-200 p-5 md:p-6 rounded-2xl flex flex-col items-center justify-between space-y-6">
                ...
                <div className="bg-white p-3 md:p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center justify-center">
                  <svg 
                    width="280" 
                    height="280" 
                    viewBox="0 0 300 300" 
                    className="bg-white rounded-lg drop-shadow-sm max-w-full h-auto"
                  >
                    {renderGridSquares()}
                  </svg>
                </div>

                <div className="bg-white border border-slate-200 px-6 py-2.5 rounded-xl shadow-sm text-center">
                  <span className="text-sm md:text-base font-black text-slate-800 tabular-nums">
                    Καλύφθηκαν: <span className="text-amber-500 font-mono text-lg">{currentNumerator}</span> / {currentDenominator} {getGridLabel()}
                  </span>
                </div>
