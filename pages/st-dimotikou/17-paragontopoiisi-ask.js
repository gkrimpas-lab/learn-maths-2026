...
function generateQuestions() {
  // Q1: MCQ - Σωστή παραγοντοποίηση ενός αριθμού σε μορφή δυνάμεων
  ...
  // Δημιουργία λανθασμένων επιλογών
  const q1Wrong1 = q1Factors.join(' × '); // Χωρίς εκθέτες (απλό γινόμενο αν έχει επαναλήψεις)
  const q1Wrong2 = getPowerRepresentation(getPrimeFactors(q1Num + 6)) || '2³ × 5';
  const q1Wrong3 = `${q1Factors[0]} × ${q1Num / q1Factors[0]}`; // Όχι πλήρης ανάλυση
  const q1Options = shuffle(Array.from(new Set([q1Correct, q1Wrong1, q1Wrong2, q1Wrong3])).slice(0, 4));

  // Q2: Input - Μικρότερος πρώτος διαιρέτης μιας περιττής σύνθετης τιμής
  ...
  // Q3: MCQ - Εύρεση αριθμού από τη μορφή δυνάμεών του
  const q3Presets = [
    { expr: '2² × 3 × 5', val: 60 },
    { expr: '2³ × 3²', val: 72 },
    { expr: '2 × 3² × 5', val: 90 },
  ...
  // Q4: MCQ - Εύρεση παράγοντα/εκθέτη που λείπει (π.χ. 72 = 2³ × _)
  const q4Presets = [
  ...
  // Q5: True / False - Μοναδικότητα παραγοντοποίησης
  ...
  // Q6: True / False - Κανόνας κατακόρυφης γραμμής
  ...
  // Q7: Input - Πλήθος πρώτων παραγόντων (με επαναλήψεις)
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Σωστά! Η ανάλυση κάθε σύνθετου αριθμού σε γινόμενο πρώτων παραγόντων είναι μοναδική (Θεμελιώδες Θεώρημα Αριθμητικής).'
    ...
    q6: {
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Σωστά! Δεξιά από τη γραμμή γράφουμε αποκλειστικά πρώτους αριθμούς (2, 3, 5, 7...).'
...
export default function ParagontopoiisiExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Παραγοντοποίηση Αριθμών - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στην παραγοντοποίηση αριθμών για τη ΣΤ' Δημοτικού." />
