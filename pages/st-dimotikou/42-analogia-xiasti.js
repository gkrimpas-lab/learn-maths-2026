...
export default function XiastiTheoryPage() {
  ...
  const [massKg, setMassKg] = useState(2.5); // kg
  const [costEur, setCostEur] = useState(4.5); // €
  const [targetMassG, setTargetMassG] = useState(1500); // g
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Οργάνωση</span>
                </div>
                ...
                <div className="bg-slate-50 p-3.5 2xl:p-5 rounded-2xl border border-slate-200 space-y-2 text-xs sm:text-sm">
                  <div className="grid grid-cols-2 gap-2 text-center font-mono">
                    <div className="bg-blue-100/70 p-2 rounded-xl text-blue-950 font-bold">Ποσό Α (π.χ. kg)</div>
                    <div className="bg-emerald-100/70 p-2 rounded-xl text-emerald-950 font-bold">Ποσό Β (π.χ. €)</div>
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Σταυρωτό Σχήμα</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
                  Το Σχήμα «Χ» (Χιαστί)
                </h3>
                ...
                <div className="bg-slate-50 p-4 2xl:p-5 rounded-2xl border border-slate-200 space-y-2 text-xs sm:text-sm 2xl:text-base font-mono">
                  <div className="flex items-center justify-center gap-3 text-base font-bold text-indigo-900">
                    <Fraction num="α" den="γ" />
                    <span>＝</span>
                    <Fraction num="β" den="χ" />
                  </div>
                  <div className="pt-2 border-t border-slate-200 text-slate-700 font-sans text-xs text-center">
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Ο Χρυσός Κανόνας</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
                ...
                <div className="bg-indigo-50/80 p-4 2xl:p-5 rounded-2xl border border-indigo-200 space-y-2 text-xs sm:text-sm">
                  <div className="font-mono font-black text-center text-indigo-950 text-sm sm:text-base">
                    χ ＝ (β · γ) : α
                  </div>
                  <div className="text-slate-700 text-xs leading-relaxed text-center pt-1 font-sans">
            ...
            <article className="bg-white p-6 sm:p-8 2xl:p-10 rounded-3xl border border-slate-200 shadow-sm flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-xs 2xl:text-sm font-semibold text-slate-500">Παγίδες &amp; Μονάδες</span>
                </div>
                <h3 className="text-lg sm:text-xl 2xl:text-2xl font-black text-slate-900">
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-md p-6 sm:p-8 2xl:p-12 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 bg-slate-50 p-6 sm:p-8 rounded-3xl border border-slate-200 space-y-6">
              ...
              {/* Πινακας 2x2 */}
              <div className="max-w-md mx-auto bg-white rounded-2xl border-2 border-slate-300 shadow-md p-4 space-y-3">
                <div className="grid grid-cols-2 gap-3 text-center border-b pb-2 border-slate-200 font-bold text-xs sm:text-sm text-slate-600">
                ...
                <div className="grid grid-cols-2 gap-4 text-center font-mono font-black text-xl sm:text-2xl text-slate-800 relative py-2">
                  {/* Γραμμη 1 */}
                  <div className="bg-slate-100 p-3 rounded-xl border border-slate-200 text-blue-800">
                    {valA}
                  </div>
                  <div className="bg-slate-100 p-3 rounded-xl border border-slate-200 text-emerald-800">
                    {valB}
                  </div>

                  {/* Γραμμη 2 */}
                  <div className="bg-slate-100 p-3 rounded-xl border border-slate-200 text-indigo-800">
                    {valC}
                  </div>
                  <div className="bg-amber-100 p-3 rounded-xl border-2 border-amber-400 text-amber-950 animate-pulse">
                    χ
                  </div>
                </div>

                <div className="text-center text-xs font-bold text-indigo-900 pt-1">
                  Σταυρωτό γινόμενο: <span className="font-mono">{valA} · χ ＝ {valB} · {valC}</span>
                </div>
              </div>

              {/* Αναλυση του τυπου */}
              <div className="bg-white p-5 rounded-2xl border border-indigo-100 text-center space-y-2">
        ...
        <section className="bg-white rounded-3xl border border-slate-200 shadow-md p-6 sm:p-8 2xl:p-12 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-3">
              ...
              <div className="p-3 bg-white rounded-xl border border-slate-200 font-mono font-bold text-slate-800 text-sm text-center">
            ...
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-3">
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-2.5 font-mono text-xs sm:text-sm text-center">
                <div className="grid grid-cols-2 gap-1 font-bold border-b pb-1 text-slate-500">
                  <span>Βάρος (kg)</span>
                  <span>Κόστος (€)</span>
                </div>
            ...
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-3">
              ...
              <div className="p-3 bg-white rounded-xl border border-slate-200 font-mono font-bold text-emerald-800 text-sm text-center space-y-1">
