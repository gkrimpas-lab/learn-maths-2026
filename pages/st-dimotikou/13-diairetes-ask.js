...
export default function DiairetesExercisesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between pb-32">
      <Head>
        <title>🎯 Ασκήσεις: Οι Διαιρέτες ενός Αριθμού - ΣΤ' Δημοτικού | LearnMaths.gr</title>
        <meta name="description" content="Διαδραστικές ασκήσεις με αυτόματη βαθμολόγηση στους διαιρέτες φυσικών αριθμών για τη ΣΤ' Δημοτικού." />
