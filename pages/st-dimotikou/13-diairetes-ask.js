...
function generateQuestions() {
  ...
  return {
    ...
    q5: {
      ...
      correct: q5IsTrue,
      explain: q5IsTrue
        ? 'Ο αριθμός 1 διαιρεί όλους ανεξαιρέτως τους φυσικούς αριθμούς.'
        : 'Ο αριθμός 1 διαιρεί όλους τους φυσικούς αριθμούς (άρτιους και περιττούς).'
    },
    q6: {
      type: 'tf',
      title: 'Πλήθος Διαιρετών',
      ...
      correct: q6IsTrue,
      explain: q6IsTrue
        ? 'Οι διαιρέτες ενός αριθμού είναι πεπερασμένοι (δεν μπορεί να είναι μεγαλύτεροι από τον ίδιο τον αριθμό).'
        : 'Οι διαιρέτες είναι πεπερασμένοι, σε αντίθεση με τα πολλαπλάσια που είναι άπειρα.'
    },
    q7: {
      type: 'input',
