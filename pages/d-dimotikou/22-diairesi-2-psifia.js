...
export default function Diairesi2PsifiaPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans flex flex-col justify-between">
      <Head>
        <title>➗ Η Διαίρεση με Διψήφιο Διαιρέτη - LearnMaths.gr</title>
        ...
        <nav className="bg-white shadow-md w-full sticky top-0 z-50">
          <div className={`${LAYOUT.CONTAINER} py-4 flex justify-between items-center`}>
            ...
            <div className="flex items-center gap-3">
              <Link href="/d-dimotikou/22-diairesi-2-psifia-ask" className="bg-emerald-600 hover:bg-emerald-700 text-white font-black px-4 py-2.5 rounded-xl text-sm transition shadow-sm flex items-center gap-2">
                <span>📝</span> Ασκήσεις
              </Link>
          ...
          <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 text-white p-8 rounded-3xl shadow-md relative overflow-hidden">
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/20 text-center space-y-3 shadow-lg">
                ...
                <p className="text-xs text-purple-100">Δοκίμασε τις ασκήσεις στη διαίρεση με διψήφιο διαιρέτη για να σιγουρευτείς ότι την έμαθες!</p>
                <Link 
          ...
          <div className="bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-emerald-50/70 p-6 rounded-2xl border border-emerald-100 space-y-3">
                ...
                <h3 className="text-lg font-bold text-emerald-900">
                  Κατεβάζουμε το Επόμενο
                </h3>
                <p className="text-xs md:text-sm text-gray-700 leading-relaxed">
                  Κατεβάζουμε το επόμενο ψηφίο δίπλα στο υπόλοιπο και επαναλαμβάνουμε τη διαδικασία μέχρι να τελειώσουν τα ψηφία!
                </p>
              </div>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 space-y-4">
              <h3 className="text-lg font-extrabold text-gray-800">
                🏷️ Οι Όροι της Διαίρεσης και η Τέλεια Επαλήθευση
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-200 space-y-2">
                  ...
                  <ul className="space-y-1 text-xs md:text-sm text-gray-700 font-mono">
                    ...
                    <li><strong className="text-blue-600">Διαιρέτης (δ):</strong> Ο διψήφιος αριθμός (10 - 99).</li>
                    <li><strong className="text-emerald-600">Πηλίκο (π):</strong> Πόσο παίρνει το κάθε μέρος.</li>
                    <li><strong className="text-amber-600">Υπόλοιπο (υ):</strong> Πόσο περισσεύει (υ &lt; δ πάντα!).</li>
                  </ul>
                </div>
          ...
          <div className="bg-white p-6 md:p-10 rounded-3xl shadow-sm border border-gray-100 space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b pb-4 border-gray-100">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                >
                  <span>✨</span> Τέλεια Διαίρεση
                </button>
              </div>
            </div>

            {/* ΠΕΔΙΑ ΕΙΣΑΓΩΓΗΣ & SLIDERS XΕΙΡΙΣΜΟΥ */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-2xl border border-slate-200">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full p-2.5 rounded-xl border border-gray-300 font-mono font-bold text-base focus:ring-2 focus:ring-indigo-500 focus:outline-none mb-2"
                />
                <input 
                  type="range" 
                  min="100" 
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full p-2.5 rounded-xl border border-gray-300 font-mono font-bold text-base focus:ring-2 focus:ring-blue-500 focus:outline-none mb-2"
                />
                <input 
                  type="range" 
                  min="10" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              {/* ΑΡΙΣΤΕΡΑ: ΤΟ ΓΡΑΦΙΚΟ ΚΑΘΕΤΗΣ ΔΙΑΙΡΕΣΗΣ */}
              <div className="flex flex-col items-center gap-2 w-full max-w-[420px] mx-auto px-1">
                ...
                <div className="w-full bg-slate-900 text-white p-6 rounded-3xl shadow-xl border-4 border-slate-700 font-mono text-xl md:text-2xl font-black relative min-h-[340px] flex py-8 select-none justify-center">
                  <div className="flex w-full items-start justify-center">
                    ...
                    <div className="text-left pl-5 flex flex-col h-full justify-start">
                      ...
                      <div className={`mt-auto pt-12 text-[11px] font-sans font-black uppercase tracking-wider ${isExact ? 'text-emerald-400' : 'text-rose-400'}`}>
                        {isExact ? '✨ Τελεια (υ = 0)' : `🏁 Υπολοιπο: ${r}`}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-emerald-50/70 p-6 md:p-8 rounded-3xl border border-emerald-200 space-y-4">
                ...
                <p className="text-xs text-emerald-900 font-medium">
                  💡 Πολλαπλασιάσαμε το πηλίκο με τον διψήφιο διαιρέτη, προσθέσαμε το υπόλοιπο και βρήκαμε ακριβώς τον αρχικό αριθμό!
                </p>

                <div className="text-xs text-slate-500 font-bold border-t pt-3 border-emerald-200">
                  🔍 Το υπόλοιπο ({r}) μιας ακέραιης διαίρεσης είναι πάντα μικρότερο από τον διαιρέτη ({d}).
                </div>
              </div>
