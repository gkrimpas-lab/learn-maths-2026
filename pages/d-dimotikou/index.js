...
export default function DDimotikouMenu() {
  ...
  { id: '4-pollaplasiasmos', label: '✖️ 4. Πολλαπλασιασμός 2 ψηφίων', href: '/d-dimotikou/4-pollaplasiasmos' },
  { id: '5-diairesi', label: '➗ 5. Διαίρεση με 1 ψηφίο', href: '/d-dimotikou/5-diairesi' },
  { id: '6-dekadikoi', label: '🍰 6. Δεκαδικά Κλάσματα', href: '/d-dimotikou/6-dekadikoi' },
  { id: '7-dekadikoi-sinexeia', label: '🪙 7. Δεκαδικά Κλάσματα και Δεκαδικοί', href: '/d-dimotikou/7-dekadikoi-sinexeia' },
  { id: '8-mikos', label: '📏 8. Μήκος', href: '/d-dimotikou/8-mikos' },
  { id: '9-baros', label: '⚖️ 9. Βάρος', href: '/d-dimotikou/9-baros' },
  ...
  { id: '13-paralliles', label: '⏸️ 13. Παράλληλες ευθείες', href: '/d-dimotikou/13-paralliles' },
