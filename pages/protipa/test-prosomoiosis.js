...
const DigitsNumber = ({ thousands, hundreds, tens, units }) => (
  <span className="inline-flex flex-col items-center font-mono font-black text-slate-900 mx-1">
    <span className="border-t-2 border-slate-900 w-full mb-[1px]"></span>
    <span>{thousands}{hundreds}{tens}{units}</span>
  </span>
);
...
const QUESTIONS = [
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Εφαρμόζουμε την <strong>προτεραιότητα των πράξεων</strong>: πρώτα τις δυνάμεις, έπειτα τις πράξεις εντός παρενθέσεων και τέλος τις διαιρέσεις και την πρόσθεση:
        </p>
        ...
        <div className="bg-white/90 p-3.5 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="510" height="170" viewBox="0 0 510 170" className="select-none font-sans mx-auto block">
            <g transform="translate(25, 20)">
              ...
              <text x="105" y="22" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#1d4ed8">1ο Μέλος</text>
              <text x="105" y="44" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#1e40af" fontFamily="monospace">(25 · 3 · 8) : 1,5 ＝ 600 : 1,5</text>
              <text x="105" y="65" fontSize="13" fontWeight="black" textAnchor="middle" fill="#2563eb" fontFamily="monospace">＝ 400 (3 : 1,5 ＝ 2 ➔ 3)</text>
            </g>
            ...
            <g transform="translate(275, 20)">
              ...
              <text x="105" y="22" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#15803d">2ο Μέλος</text>
              <text x="105" y="44" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#14532d" fontFamily="monospace">(30 － 16) : 0,5 ＝ 14 : 0,5</text>
        ...
        <div className="bg-white/80 p-3.5 rounded-2xl border border-slate-200/90 space-y-2 font-mono">
          <div>• <strong>1η Παρένθεση:</strong> (0,6 : 0,02 － 4²) ＝ (30 － 16) ＝ <strong>14</strong>.</div>
          <div>• <strong>Διαίρεση:</strong> 14 : 0,5 ＝ 14 · 2 ＝ <strong>28</strong>.</div>
          <div>• <strong>Πρόσθεση όρων:</strong> 3 ＋ 28 ＝ <strong className="text-emerald-700">31,0</strong>.</div>
        </div>
      </div>
    )
  },
  {
    ...
    prompt: (
      <span>
        Ο αριθμός <DigitsNumber thousands="3" hundreds="4" tens="Α" units="Β" /> είναι τετραψήφιος φυσικός αριθμός, όπου τα <strong>Α</strong> και <strong>Β</strong> παριστάνουν άγνωστα ψηφία. Γνωρίζουμε ότι ο αριθμός αυτός διαιρείται ακριβώς τόσο με το 9 όσο και με το 10. Ποια είναι η τιμή του ψηφίου Α;
      </span>
    ),
    options: ['1', '2', '4', '6'],
    correct: '2',
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Συμβολίζουμε τον τετραψήφιο αριθμό με τα άγνωστα ψηφία του ως <DigitsNumber thousands="3" hundreds="4" tens="Α" units="Β" />. Εφαρμόζουμε τα <strong>κριτήρια διαιρετότητας</strong> για το 10 και το 9:
        </p>

        {/* SVG ΣΧΗΜΑ 2: ΑΝΑΛΥΣΗ ΤΩΝ 4 ΨΗΦΙΩΝ */}
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="490" height="155" viewBox="0 0 490 155" className="select-none font-sans mx-auto block">
            {[
              ...
              <g key={i} transform={`translate(${45 + i * 105}, 20)`}>
                <rect
                  ...
                  strokeWidth="2"
                />
                <text x="42.5" y="38" fontSize="16" fontWeight="black" textAnchor="middle" fill={box.isTarget ? '#15803d' : box.isFixed ? '#1d4ed8' : '#0f172a'} fontFamily="monospace">
                  {box.d}
                </text>
            ...
            <g transform="translate(45, 105)">
              ...
              <text x="200" y="21" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#ffffff">
        ...
        <div className="bg-white/80 p-3.5 rounded-2xl border border-slate-200/90 space-y-2 font-mono">
          <div>1. <strong>Κριτήριο διαιρετότητας με το 10:</strong></div>
          <div className="pl-3 text-slate-700">
            Ένας φυσικός αριθμός διαιρείται με το 10 αν και μόνο αν το τελευταίο του ψηφίο είναι 0. Επομένως: <strong className="text-blue-700">Β ＝ 0</strong>. Ο αριθμός έχει τη μορφή 34Α0.
          </div>

          <div className="pt-1 border-t border-slate-200">2. <strong>Κριτήριο διαιρετότητας με το 9:</strong></div>
          <div className="pl-3 text-slate-700">
            Το άθροισμα των ψηφίων του πρέπει να διαιρείται ακριβώς με το 9:
          </div>
          <div className="pl-3 font-bold text-slate-800">
            3 ＋ 4 ＋ Α ＋ 0 ＝ 7 ＋ Α
          </div>
          <div className="pl-3 text-slate-700">
            Επειδή το Α είναι μονοψήφιος αριθμός (0 έως 9), το μοναδικό πολλαπλάσιο του 9 που προσεγγίζεται είναι το 9:
          </div>
          <div className="pl-3 text-emerald-700 font-bold text-base">
            7 ＋ Α ＝ 9 ➔ Α ＝ 9 － 7 ＝ 2 ⭐
          </div>
          <div className="text-slate-500 font-sans text-xs pt-1">
            (Ο τετραψήφιος αριθμός είναι ο 3.420: διαιρείται με το 10 αφού λήγει σε 0 και με το 9 αφού 3+4+2+0 = 9).
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Μετατρέπουμε όλα τα κλάσματα σε ομώνυμα με κοινό παρονομαστή το 100 (δεκαδικοί) για να συγκρίνουμε τις αποστάσεις τους από το <Fraction num="3" den="5" /> ＝ <strong>0,60</strong>:
        </p>

        {/* SVG ΣΧΗΜΑ 3 */}
        <div className="bg-white/90 p-3.5 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="510" height="160" viewBox="0 0 510 160" className="select-none font-sans mx-auto block">
            <line x1="30" y1="80" x2="480" y2="80" stroke="#334155" strokeWidth="2" />
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          ...
          <div>• 1/2 ＝ 0,50 ➔ |0,60 － 0,50| ＝ 0,10</div>
          <div>• 7/10 ＝ 0,70 ➔ |0,60 － 0,70| ＝ 0,10</div>
          <div>• 13/25 ＝ 52/100 ＝ 0,52 ➔ |0,60 － 0,52| ＝ 0,08</div>
          <div className="text-emerald-700 font-bold">• 11/20 ＝ 55/100 ＝ 0,55 ➔ |0,60 － 0,55| ＝ 0,05 ⭐ (Ελάχιστη)</div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Έστω ότι η αρχική τιμή είναι <strong>100 €</strong>:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Αύξηση 25%: 100 ＋ 25 ＝ <strong>125 €</strong>.</div>
          <div>• Μείωση 20% επί των 125 €: 0,20 · 125 ＝ <strong>25 €</strong>.</div>
          <div>• Τελική τιμή: 125 － 25 ＝ <strong>100 €</strong>.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            Η τελική τιμή είναι ίδια με την αρχική: <strong>καμία μεταβολή (0%)</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Εφαρμόζουμε τη μέθοδο της υπόθεσης:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Αν όλα ήταν κοτόπουλα: 25 · 2 ＝ 50 πόδια.</div>
          <div>• Περισσεύουν: 70 － 50 ＝ 20 πόδια.</div>
          <div>• Κάθε κατσίκα έχει 2 επιπλέον πόδια από το κοτόπουλο.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Κατσίκες: 20 : 2 ＝ <strong>10</strong> (και 15 κοτόπουλα).
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Υπολογίζουμε πρώτα το εμβαδόν του ορθογωνίου και έπειτα την πλευρά και περίμετρο του τετραγώνου:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Εμβαδόν: 18 · 8 ＝ 144 τ.εκ.</div>
          <div>• Πλευρά τετραγώνου: α · α ＝ 144 ➔ <strong>α ＝ 12 εκ.</strong></div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Περίμετρος τετραγώνου: 4 · 12 ＝ <strong>48 εκ.</strong>
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Συγκρίνουμε τα αθροίσματα των βαθμών:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Άθροισμα στα 4 τεστ: 4 · 16 ＝ 64.</div>
          <div>• Νέο άθροισμα στα 5 τεστ: 5 · 17 ＝ 85.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Βαθμός 5ου τεστ: 85 － 64 ＝ <strong>21</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Η ακολουθία έχει σταθερό βήμα ＋5:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• 1ος όρος: 4.</div>
          <div>• Για τον 40ό όρο, προσθέτουμε 39 φορές το 5: 39 · 5 ＝ 195.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
  ...
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Από την ταυτότητα της διαίρεσης: <span className="font-mono font-bold">Δ ＝ δ · π ＋ υ</span>, με <span className="font-mono font-bold">υ &lt; δ</span>:
        </p>
        ...
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="480" height="135" viewBox="0 0 480 135" className="select-none font-sans mx-auto block">
            <g transform="translate(30, 20)">
              ...
              <text x="210" y="24" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#1d4ed8">δ ＝ 12, π ＝ 15 ➔ δ · π ＝ 180</text>
              <text x="210" y="40" fontSize="10.5" fontWeight="black" textAnchor="middle" fill="#1e40af">Μέγιστο υπόλοιπο: υ_max ＝ δ － 1 ＝ 11</text>
            </g>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Διαιρέτης 12 ➔ Μέγιστο δυνατό υπόλοιπο: <strong>υ ＝ 11</strong>.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
  ...
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Εξετάζουμε τα κλάσματα που απομένουν:
        </p>
        ...
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="490" height="150" viewBox="0 0 490 150" className="select-none font-sans mx-auto block">
            <g transform="translate(20, 20)">
              ...
              <text x="70" y="27" fontSize="10.5" fontWeight="bold" textAnchor="middle" fill="#dc2626">Βιβλίο: 1/3</text>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Υπόλοιπο μετά το βιβλίο: 2/3.</div>
          <div>• Τα 3/4 του υπολοίπου ισούνται με 30 € ➔ Υπόλοιπο: 30 · (4/3) ＝ <strong>40 €</strong>.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Αρχικό ποσό: 40 · (3/2) ＝ <strong>60 €</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Υπολογίζουμε το καθαρό αλάτι και το συνολικό βάρος:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Αλάτι Α: 10% · 200 ＝ 20 g | Αλάτι Β: 20% · 300 ＝ 60 g.</div>
          <div>• Συνολικό αλάτι: 20 ＋ 60 ＝ 80 g σε σύνολο 500 g διαλύματος.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Ποσοστό: 80 / 500 ＝ <strong>16%</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Αφαιρούμε το εμβαδόν του κύκλου από το εμβαδόν του τετραγώνου:
        </p>
        ...
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="460" height="170" viewBox="0 0 460 170" className="select-none font-sans mx-auto block">
            ...
            <g transform="translate(230, 25)">
              ...
              <text x="16" y="24" fontSize="10.5" fontWeight="bold" fill="#0f172a">• Ε_τετρ ＝ 20 · 20 ＝ 400</text>
              <text x="16" y="48" fontSize="10.5" fontWeight="bold" fill="#0f172a">• r ＝ 20 : 2 ＝ 10 εκ.</text>
              <text x="16" y="70" fontSize="10.5" fontWeight="bold" fill="#0f172a">• Ε_κυκλ ＝ 3,14 · 10² ＝ 314</text>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Ε_τετρ ＝ 20 · 20 ＝ 400 τ.εκ.</div>
          <div>• Ε_κυκλ ＝ 3,14 · 10² ＝ 314 τ.εκ.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Εμβαδόν γωνιών: 400 － 314 ＝ <strong>86 τ.εκ.</strong>
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Τα καράβια συναντώνται μετά από Ε.Κ.Π.(12, 18) ημέρες:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Ε.Κ.Π.(12, 18) ＝ 36 ημέρες.</div>
          <div>• Μέχρι το τέλος Μαΐου: 31 － 1 ＝ 30 ημέρες.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Υπόλοιπο: 36 － 30 ＝ 6 ημέρες του Ιουνίου ➔ <strong>6 Ιουνίου</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Εκφράζουμε τα ποσά με άγνωστο τα χρήματα του Γιάννη (x):
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Γιάννης: x | Μαρία: x ＋ 15 | Κώστας: 2 · (x ＋ 15) ＝ 2x ＋ 30.</div>
          <div>• 4x ＋ 45 ＝ 125 ➔ 4x ＝ 80.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Ο Γιάννης έχει <strong>20 €</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Σταθμισμένος μέσος όρος στο σύνολο των 25 μαθητών:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Συνολικοί βαθμοί: 140 ＋ 247,5 ＝ 387,5.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Μ.Ο. Τμήματος: 387,5 : 25 ＝ <strong>15,5</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Σε κάθε βήμα προστίθενται 4 τετράγωνα:
        </p>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Τύπος: 1 ＋ 4 · (Ν － 1) ＝ 97.</div>
          <div>• 4 · (Ν － 1) ＝ 96 ➔ Ν － 1 ＝ 24.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • <strong>Ν ＝ 25</strong>.
          </div>
        </div>
  ...
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Υπολογίζουμε την αρχική τιμή (100%) και μετά τη νέα έκπτωση:
        </p>
        ...
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="480" height="145" viewBox="0 0 480 145" className="select-none font-sans mx-auto block">
            <g transform="translate(20, 20)">
              <rect x="0" y="0" width="200" height="55" rx="8" fill="#eff6ff" stroke="#3b82f6" strokeWidth="1.6" />
              <text x="100" y="22" fontSize="10.5" fontWeight="bold" textAnchor="middle" fill="#1d4ed8">70% (με έκπτωση 30%)</text>
            ...
            <g transform="translate(260, 20)">
              ...
              <text x="100" y="22" fontSize="10.5" fontWeight="bold" textAnchor="middle" fill="#166534">90% (με έκπτωση 10%)</text>
            ...
            <g transform="translate(60, 95)">
              ...
              <text x="180" y="22" fontSize="11.5" fontWeight="bold" textAnchor="middle" fill="#ffffff" fontFamily="monospace">
                Αρχική: 300 € ➔ Νέα Τιμή: 300 － 30 ＝ 270 €
              </text>
            </g>
          </svg>
        </div>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• 70% ＝ 210 € ➔ Αρχική τιμή: 210 : 0,70 ＝ 300 €.</div>
          <div>• Με έκπτωση 10%: 300 － 10% · 300 ＝ 300 － 30.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Νέα τιμή: <strong>270 €</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        ...
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="480" height="150" viewBox="0 0 480 150" className="select-none font-sans mx-auto block">
            <g transform="translate(30, 35)">
              ...
              <text x="25" y="24" fontSize="9.5" fontWeight="bold" textAnchor="middle" fill="#1d4ed8">Ε_1</text>
            </g>
            ...
            <g transform="translate(265, 30)">
              ...
              <text x="16" y="24" fontSize="10.5" fontWeight="bold" fill="#0f172a">• Νέο: 600%</text>
              <text x="16" y="46" fontSize="10.5" fontWeight="bold" fill="#0f172a">• Αρχικό: 100%</text>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Ε_2 ＝ (2 · μήκος) · (3 · πλάτος) ＝ 6 · (μήκος · πλάτος) ＝ 6 · Ε_1.</div>
          <div>• Το εμβαδόν εξαπλασιάστηκε (έγινε 600%).</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Αύξηση: 600% － 100% ＝ <strong>500%</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Κάνουμε τα κλάσματα ομώνυμα με παρονομαστή 15:
        </p>
        ...
        <div className="bg-white/90 p-3.5 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="490" height="150" viewBox="0 0 490 150" className="select-none font-sans mx-auto block">
            <g transform="translate(20, 20)">
              ...
              <text x="90" y="27" fontSize="10.5" fontWeight="bold" textAnchor="middle" fill="#1d4ed8">⚽ Ποδόσφαιρο: 6/15</text>

              <rect x="185" y="0" width="150" height="45" rx="4" fill="#fef3c7" stroke="#f59e0b" strokeWidth="1.5" />
              <text x="260" y="27" fontSize="10.5" fontWeight="bold" textAnchor="middle" fill="#b45309">🏀 Μπάσκετ: 5/15</text>
            ...
            <g transform="translate(20, 85)">
              ...
              <text x="220" y="23" fontSize="12" fontWeight="bold" textAnchor="middle" fill="#ffffff" fontFamily="monospace">
                4 μέρη ＝ 16 παιδιά ➔ 1 μέρος ＝ 4 ➔ Σύνολο (15 μέρη) ＝ 60 παιδιά
              </text>
            </g>
          </svg>
        </div>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• 2/5 ＋ 1/3 ＝ 6/15 ＋ 5/15 ＝ 11/15.</div>
          <div>• Κολύμπι: 1 － 11/15 ＝ 4/15 ＝ 16 παιδιά.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Σύνολο: 16 : (4/15) ＝ 16 · (15/4) ＝ <strong>60 παιδιά</strong>.
          </div>
        </div>
      </div>
    )
  },
  {
    ...
    prompt: (
      <span>
        Ψάχνουμε έναν διψήφιο αριθμό <DigitsNumber thousands="" hundreds="" tens="Χ" units="Υ" /> τέτοιον ώστε: (1) είναι περιττός (μονός) αριθμός, (2) αν διαιρεθεί με το 5 αφήνει υπόλοιπο 3, και (3) το άθροισμα των ψηφίων του Χ ＋ Υ είναι ίσο με 11. Ποιος είναι ο αριθμός ΧΥ;
      </span>
    ),
    ...
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        <p>
          Συνδυάζουμε τις τρεις συνθήκες:
        </p>
        ...
        <div className="flex justify-center p-3 bg-white/90 rounded-2xl border border-slate-200/90 my-2 overflow-x-auto">
          <svg width="490" height="150" viewBox="0 0 490 150" className="select-none font-sans mx-auto block">
            ...
            <g transform="translate(175, 20)">
              ...
              <text x="70" y="44" fontSize="11" fontWeight="black" textAnchor="middle" fill="#1e40af" fontFamily="monospace">Απορρίπτεται το 8 ➔ Υ ＝ 3</text>
            </g>
            ...
            <g transform="translate(45, 100)">
              ...
              <text x="200" y="22" fontSize="11.5" fontWeight="black" textAnchor="middle" fill="#ffffff" fontFamily="monospace">
                Επαλήθευση: 83 : 5 ＝ 16 (υπ. 3) &nbsp;|&nbsp; 8 ＋ 3 ＝ 11 &nbsp;|&nbsp; Μονός ✔️
              </text>
            </g>
          </svg>
        </div>
        ...
        <div className="bg-slate-50 p-3 rounded-xl border border-slate-200/80 font-mono space-y-1.5">
          <div>• Διαίρεση με το 5 και υπόλοιπο 3 ➔ Τελευταίο ψηφίο Υ ＝ 3 ή 8.</div>
          <div>• Περιττός αριθμός ➔ Υποχρεωτικά <strong>Υ ＝ 3</strong>.</div>
          <div>• Χ ＋ Υ ＝ 11 ➔ Χ ＋ 3 ＝ 11 ➔ <strong>Χ ＝ 8</strong>.</div>
          <div className="text-emerald-700 font-bold pt-1 border-t border-slate-200">
            • Ο αριθμός είναι το <strong>83</strong>.
          </div>
        </div>
      </div>
    )
