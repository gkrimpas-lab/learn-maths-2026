...
const QUESTIONS_2025 = [
  ...
  },
  {
    ...
    correctRaw: 'Γ',
    explain: 'Πιθανότητες:\n• Περίπτωση Α: Να έρθει «γράμματα» = 1/2 = 50%\n• Περίπτωση Β:  1/6 ≈ 16,7%\n• Περίπτωση Γ:  Οι αριθμοί {2, 3, 4, 5, 6} είναι > του 1. Άρα κερδίζω αν έρθει 2 ή 3 ή 4 ή 4 ή 6. Προσθέτω τις περιπτώσεις που κερδίζω και είναι 5 στις 6 περιπτώσεις: 5/6 ≈ 83,3%\n• Περίπτωση Δ:  Να μην έρθει «γράμματα» σημαίνει να έρθει «κεφαλή» = 1/2 = 50%.\nΠιθανότερο είναι το ενδεχόμενο Γ (5/6 ≈ 83,3%).'
  },
  {
    id: 5,
    officialNumber: 25,
