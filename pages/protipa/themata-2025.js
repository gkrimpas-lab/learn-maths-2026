...
const QUESTIONS_2025 = [
  ...
  },
 {
  ...
  },
  {
    ...
    officialNumber: 38,
    group: 'ΟΜΑΔΑ Β (5 Επιλογες)',
    promptText: 'Ένα ορθογώνιο παραλληλόγραμμο έχει υποδιαιρεθεί σε εννιά μικρότερα ορθογώνια παραλληλόγραμμα διαφορετικών διαστάσεων, όπως στο σχήμα που ακολουθεί. Αν οι περίμετροι των Α, Β και Γ είναι 36 εκ., 56 εκ. και 50 εκ. αντίστοιχα, ποια είναι η περίμετρος του αρχικού ορθογωνίου;',
    options: [
      { key: 'A', label: '138 εκ.', raw: '138' },
      { key: 'B', label: '150 εκ.', raw: '150' },
      { key: 'Γ', label: '146 εκ.', raw: '146' },
      { key: 'Δ', label: '142 εκ.', raw: '142' },
      { key: 'E', label: 'Δεν μπορούμε να την υπολογίσουμε με βάση τα δεδομένα', raw: 'none' }
    ],
    correctRaw: '142',
    explain: (
      <div className="space-y-4 text-xs sm:text-sm">
        ...
        <div className="bg-white/80 p-3.5 rounded-xl border border-slate-200/80 font-mono text-slate-900 space-y-1.5">
          ...
          <div>Περίμετρος Μεγάλου ＝ 36 ＋ 56 ＋ 50 ＝ <strong className="text-emerald-700 text-base">142 εκ.</strong></div>
        </div>

        <p className="pt-1">
          Επομένως, η περίμετρος του αρχικού μεγάλου ορθογωνίου είναι <strong>142 εκ.</strong> (Επιλογή <strong>Γ</strong>).
        </p>
      </div>
    )
  },
...
export default function Themata2025Page() {
  ...
  return (
    <Layout
      ...
      description="Επίσημα θέματα εξετάσεων εισαγωγής στα Πρότυπα Σχολεία 2025: 20 θέματα, 2 μόρια ανά θέμα τα 10 πρώτα, 3 μόρια ανά θέμα τα υπόλοιπα 10 (0-50 μόρια), χρονόμετρο και αναλυτικές λύσεις."
