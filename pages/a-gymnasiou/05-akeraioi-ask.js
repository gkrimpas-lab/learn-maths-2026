...
const EXERCISE_GENERATORS = [
  ...
  () => {
    return {
      ...
      options: makeUniqueOptions('Ο －1', ['Ο 0', 'Ο －10', 'Δεν υπάρχει']),
      correctAnswer: 'Ο －1',
      solution: `Ο αριθμός －1 είναι ο αρνητικός ακέραιος που βρίσκεται πιο κοντά στο 0 (έχει τη μικρότερη δυνατή απόλυτη τιμή ανάμεσα στους αρνητικούς), επομένως είναι ο μεγαλύτερος όλων.`,
    };
  },
