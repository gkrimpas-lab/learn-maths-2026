        ...
        <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-950 via-indigo-900 to-indigo-800 text-white p-6 sm:p-10 shadow-xl border border-indigo-700/50">
          <div className="max-w-4xl space-y-3">
            ...
            <p className="text-sm sm:text-base text-indigo-100/90 leading-relaxed">
              Δοκίμασε τις δυνάμεις σου σε 20 επιλεγμένες ασκήσεις υψηλής δυσκολίας (3 από κάθε κεφάλαιο και 2 συνδυαστικά προβλήματα). Στο τέλος πάτησε «ΕΛΕΓΧΟΣ ΑΠΑΝΤΗΣΕΩΝ» για να δεις τη βαθμολογία σου και αναλυτικές λύσεις.
            </p>
          </div>
        </section>
