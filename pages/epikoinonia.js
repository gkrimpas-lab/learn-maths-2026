              ...
              <div className="space-y-6 flex flex-col justify-between">
                <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                  ...
                  <p className="text-gray-700 text-sm md:text-base leading-relaxed">
                    Ονομάζομαι <strong>Δημήτρης Γκρίμπας</strong> και είμαι ο δημιουργός του LearnMaths.gr. Στόχος μου είναι να κάνω τη μάθηση των Μαθηματικών προσιτή, διαδραστική και κατανοητή για κάθε μαθητή.
                  </p>
                </div>
