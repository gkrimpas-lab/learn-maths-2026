...
export default function EDimotikouMenu() {
  const modules = [
    ...
    { id: '10-mesitimi', label: '📊 11. Μέση Τιμή', href: '/e-dimotikou/10-mesitimi' },
    { id: '11-pososta', label: '🏷️ 12. Ποσοστά', href: '/e-dimotikou/11-pososta' },
    ...
    { id: '16-apostasi-simeiou-eutheias', label: '🔺 17. Απόσταση Σημείου από Ευθεία', href: '/e-dimotikou/16-apostasi-simeiou-eutheia' },
    ...
    { id: '25-embado-sximaton', label: '🔺 26. Εμβαδό Σχημάτων', href: '/e-dimotikou/25-embado-sximaton' },
    { id: '26-monades-epifaneias', label: '🔺 27. Μονάδες Μέτρησης Επιφάνειας', href: '/e-dimotikou/26-monades-epifaneias' },
